...
`text` enables us to add texts to our plots. Similarly to `points`,`lines`, and `abline` we can add `text` to any plot. For the example below, we will focus on scatter plots.
