...
`nchar` is a function which counts the number of charaters and symbols in a word or a string. Punctuation and blanck spaces are counted as well.
...
Side note: "pneumonoultramicroscopicsilicovolcanoconiosis" is the longest word in the english dictionary.
<details>
    <summary>Click here for solution</summary>
```{r, eval=T}
