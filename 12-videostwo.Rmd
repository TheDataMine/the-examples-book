# Video option 2: links (recommended by me)
...
**[Click here for video](https://www.youtube.com/watch?v=fIwhGmwMK7E)**

**>[Click here for video](https://www.youtube.com/watch?v=fIwhGmwMK7E)<**

**>[Click here for video](https://www.youtube.com/watch?v=fIwhGmwMK7E)**

**_[Click here for video](https://www.youtube.com/watch?v=fIwhGmwMK7E)_**
...
`r ''````{r declare-variable-290-vv, eval=FALSE}
my_variable <- c(1,2,3)
```
...
```{r my-new-install-packages-290-vv, eval=F}
plot(my_variable)
```
...
```{r my-new-install-packages-390-vv, eval=F}
plot(my_variable)
```
