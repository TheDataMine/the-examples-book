...
`touch` is the command to create an empty file. It is useful if you would later add contents to it. To use this command, type `touch` followed by the file name (with the intended file path added when necessary).
