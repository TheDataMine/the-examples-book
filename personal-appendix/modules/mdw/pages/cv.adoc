...
. The Number of Distinct Adjacent Pairs in Geometrically Distributed Words: A Probabilistic and Combinatorial Analysis, by Guy Louchard, Werner Schachinger, and Mark Daniel Ward, submitted for publication.
. Developing Students from All Backgrounds in Data Science for the Government, by Rebecca Sharples and Mark Daniel Ward.  Chapter in book Pivoting Government Through Digital Transformation by Jay Liebowitz, to be published by Taylor & Francis.  Accepted for publication, 22 pages (2023).
