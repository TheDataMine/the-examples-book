...
[%reversed]
. The Data Mine Model for Accessible Partnerships in Data Science, by Maggie Betz, Rebecca Sharples, and Mark Daniel Ward, accepted for publication in WIREs Computational Statistics
