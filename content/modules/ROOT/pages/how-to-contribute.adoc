...
To include a block image from same module: image::figure01.png[Alternate text for figure01]

To include an image inline from different module: image::book:geospatial:crs.png[Alternate text for CRS]

To include a clickable/expandable image from same module: image:figure01.png["Alternate text for figure01", width=128, link="/images/figure01.png"]
