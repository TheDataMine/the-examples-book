...
. First, create a new branch from the "master" branch describing what you are doing, for example, "add-example-reading-data". To do this, click on the middle tab in GitHub Desktop which will show your current branch. Switch branches to the "master" branch. Once complete, click on the middle tab again, and click the btn:[New Branch] button.
+
image::figure11.webp[Click the New Branch button, width=792, height=500, loading=lazy, title="Click the New Branch button"]
+
. You will be presented with a field and description. Ensure that you are creating a branch from the "master" branch. Enter the new branch name in the text area.
+
[IMPORTANT]
...
+
. Once published, your branch will be available to everyone using GitHub. In order to incorporate the changes in this branch to the "master" branch, we must create a _pull request_ or _merge request_. Click the blue btn:[Create Pull Request] button.
+
...
. First, create a new branch from the "master" branch describing what you are doing, for example, "add-pd-dataframe-page". To do this, click on the middle tab in GitHub Desktop which will show your current branch. Switch branches to the "master" branch. Once complete, click on the middle tab again, and click the btn:[New Branch] button.
+
image::figure11.webp[Click the New Branch button, width=792, height=500, loading=lazy, title="Click the New Branch button"]
+
. You will be presented with a field and description. Ensure that you are creating a branch from the "master" branch. Enter the new branch name in the text area.
