...
When prompted for a passphrase, just press enter twice _without_ entering a passphrase. Congratulations! You have your new key pair!
...
PYTHONPATH=/scratch/brown/kamstut/tdm/bin/.pyenv/shims/python poetry install
----
...
module unload python/f2021-s2022-py3.9.6
cd $HOME/f2021-stat39000-project6
poetry add packagename # where packagename is the name of the package you want to install
----
