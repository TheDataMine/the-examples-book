...
Okay, great. Now, let's study the sample of our `1988.csv` dataset. Create a markdown list of key:value pairs for each column in the dataset. Each _key_ should be the title of the column, and each _value_ should be the _type_ of data that is stored in that column.
...
The next step in the project is to add the data! Duh, it _is_ a _data_base. 
