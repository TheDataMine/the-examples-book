...
get_probability_of_review(interactions_dataset = interactions, userID = 68055, min_rating = 3)
----
...
[source,r]
----
get_probability_of_review(interactions_dataset = interactions, userID = 68055)
----
...
[source,r]
----
get_probability_of_review(userID = 68055, interactions_dataset = interactions)
----
...
[source,r]
----
get_probability_of_review(interactions, 68055)
----
...
Test your modified function on userID 68055.  Do you get the same results as above?
