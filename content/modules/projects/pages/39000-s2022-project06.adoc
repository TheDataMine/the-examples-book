...
[IMPORTANT]
====
In order for the `imagehash` library to work, we need to make sure the libffi dependency is loaded up. Before executing the hash script in your `srun` command, first prepend `module load libffi/3.4.2;`.
