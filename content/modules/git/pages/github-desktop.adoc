...
Appearance::
- Change your theme from btn:[Light] to btn:[Dark].
Prompts::
...
+
. At this stage, you have a variety of options, and there is no wrong way to proceed. Let's assume, however, that we are installing GitHub Desktop in hopes of making a contribution to this book (who wouldn't want to?!). Click on menu:Clone\ a\ Repository\ from\ the\ Internet...[URL]. In the first field, enter "TheDataMine/the-examples-book", and in the second, choose the path where you'd like the repository to live. In this case, `/Users/kamstut/projects/the-examples-book` was chosen.
+
