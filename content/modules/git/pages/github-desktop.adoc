...
. Click on **Sign in to GitHub.com**. This should launch your default browser and present you with the following screen.

image::figure02.webp[Sign in to GitHub to continue to GitHub Desktop, width=792, height=500, loading=lazy, title="Sign in to GitHub to continue to GitHub Desktop"]

. Enter your GitHub credentials and click **Sign in**. If you are asked if you'd like to open something up in the GitHub Desktop application, click okay.
