...
You can find a list of common data formats https://the-examples-book.com/tools/introduction-data-formats[here].
...
// dead-link: xref:data-modeling/process/eda.adoc[EDA]
