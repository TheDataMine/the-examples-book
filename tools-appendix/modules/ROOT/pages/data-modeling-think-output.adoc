...
// dead-link: xref:data-modeling/choosing-model/index.adoc[Starter Guides on choosing models]
...
// dead-link: xref:data-modeling/general-principles/function-x.adoc[the commentary on what a function means in data science]
...
// dead-link: xref:data-modeling/process/measure-fit.adoc[metrics used to measure performance]
...
// dead-link: xref:data-modeling/process/measure-fit.adoc[metrics]
...
// dead-link: xref:data-modeling/choosing-model/index.adoc[the choosing models section]
