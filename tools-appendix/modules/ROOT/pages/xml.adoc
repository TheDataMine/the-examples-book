...
// dead-link: xref:r:xpath-expressions.adoc[XPath expressions in R]
* XPath expressions in R
// dead-link: xref:python:xpath-expressions.adoc[XPath expressions in Python]
