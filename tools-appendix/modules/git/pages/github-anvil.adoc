...
To open a terminal session, we recommend using Anvil Cloud at notebook.anvilcloud.rcac.purdue.edu, which is our most up-to-date interface. If you prefer this option, you can follow the setup instructions here: https://the-examples-book.com/setup. If you want to use OnDemand which we use in the video tutorial below, please refer to this guide: https://the-examples-book.com/tools/anvil/anvil-getting-started (scroll down to the OnDemand section). 
...
image::ondemand_screenshot.png[The OnDemand Options Bar, width=792, height=500, title="DataMine Server"]
