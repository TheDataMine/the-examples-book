...
[IMPORTANT]
====
In order to get access to GPUs on Anvil, you NEED to submit a support ticket to the Data Science team. Purdue students can submit a ticket using this link:
