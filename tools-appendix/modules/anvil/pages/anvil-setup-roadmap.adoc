...
. If you have a Purdue ID and email, follow the steps here: https://the-examples-book.com/tools/anvil/purdue-user-setup[Purdue setup]
. If you're from a University other than Purdue, follow the steps here: https://the-examples-book.com/tools/anvil/general-user-setup[Non-Purdue University setup]
. If you didn't find your University in step 2 or your from a corporation, follow the steps here: https://the-examples-book.com/tools/anvil/other-user-setup[ACCESS authentication setup]
