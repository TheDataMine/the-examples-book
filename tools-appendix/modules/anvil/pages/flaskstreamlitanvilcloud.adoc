...
**Why Use notebook.anvilcloud.rcac.purdue.edu?**
...
In order to start running flask you'll need an app.py file. If you don't already have one you can run this command below to make your own app.py file:
...
[source]
----
https://notebook.anvilcloud.rcac.purdue.edu/user/<YOUR-USERNAME>/proxy/5000/
----
...
If the URL does not work, you most likely need to relaunch your notebook session. 
