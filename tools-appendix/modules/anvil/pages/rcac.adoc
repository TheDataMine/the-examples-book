...
// dead-link: xref:brown.adoc[Brown]
// dead-link: xref:geddes.adoc[Geddes]
Web page with a list of computing resources available to you at RCAC, including but not limited to: xref:scholar.adoc[Scholar], Brown, Geddes, and xref:anvil.adoc[Anvil].
