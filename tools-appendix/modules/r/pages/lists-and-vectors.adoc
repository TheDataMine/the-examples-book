...
R will display a warning when a recycled vector is used in an operation. It is critical that you pay attention to this warning as it is often a sign that something unintentional is occurring.
