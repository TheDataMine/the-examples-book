...
image::tidyverse_groupby_example_1.png[]
...
image::tidyverse_groupby_example_2.png[]
...
// dead-link: https://rawgit.com/rstudio/cheatsheets/master/lubridate.pdf
https://github.com/rstudio/cheatsheets/blob/main/lubridate.pdf[Lubridate Cheatsheet]