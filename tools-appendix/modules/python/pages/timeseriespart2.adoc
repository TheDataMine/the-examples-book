= TDM 40100: Project 9 - Introduction to Time Series - Part 2 (NOAA Monthly Climate Data)
:page-mathjax: true
...
image::TimeSeriesSection2_1e.png[width=600, height=450, caption="Monthly average dry bulb temperature in Indianapolis over time"]
...
image::TimeSeriesSection2_2c.png[width=600, height=450, title="Current vs previous month temperature"]
...
== Question 3: ARIMA and Stationarity (2 points)
...
image::TimeSeriesSection2_3c.png[width=600, height=450, title="First-order differenced temperature series"]
...
== Question 4: Fit a Baseline ARIMA Model and Evaluate Performance (2 points)
...
image::TimeSeriesSection2_4c.png[width=600, height=450, title="Actual vs Fitted Temperature"]
...
image::TimeSeriesSection2_5c.png[width=600, height=450, title="Actual vs Fitted Temperature"]
...
image::TimeSeriesSection2_6b.png[width=600, height=450, title="Actual Temperatures, Test Forecasts, and Future Predictions"]
...
Use the final plot and forecasted values to reflect on how the SARIMAX model behaves when projecting into the future. Consider whether the forecast:
