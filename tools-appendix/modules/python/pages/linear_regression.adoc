...
plt.xlabel("Popularity") # Students need to fill the label in
plt.ylabel("Count") # Students need to fill the label in
plt.title("Distribution of Track Popularity") # Students need to fill the label in
plt.show()
----
