...
If you are a member of The Data Mine, make sure you follow the https://the-examples-book.com/tools/anvil/anvil-setup-roadmap[Anvil setup roadmap] and can launch a Jupyter Notebook session. 
...
* https://the-examples-book.com/tools/[Data Modeling]
// dead-link: https://the-examples-book.com/tools/introduction-data-analysis-techniques[Data Analysis]
* Data Analysis
