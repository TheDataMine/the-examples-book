...
- Social Media: one of the biggest targets for scraping, because public sentiment can be analyzed here (see xref:ROOT:nlp-sentiment-analysis.adoc[Sentiment Analysis])
