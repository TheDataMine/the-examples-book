...
// dead-link: xref:starter-guides:data-engineering:index.adoc[Data Engineering]
* Data Engineering
// dead-link: xref:starter-guides:data-science:index.adoc[Data Science]
* Data Science
// dead-link: xref:starter-guides:intro:index.adoc[Introduction Pages]
* Introduction Pages
// dead-link: xref:starter-guides:tools-and-standards:index.adoc[Tools and Standards]
* Tools and Standards
