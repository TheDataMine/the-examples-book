...
- https://the-examples-book.com/tools/unix/standard-utilities[Standard Utilities]
- xref:text-editors.adoc[Text Editors]
- https://the-examples-book.com/tools/unix/other-topics[Other Topics]

== Resources

Open Group holds the trademark for http://www.unix.org/[UNIX]. They provide the Single UNIX Specification Version 4 (login required; no cost to register).
// dead-link: http://www.unix.org/single_unix_specification/[Single UNIX Specification Version 4]
