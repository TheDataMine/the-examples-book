...
// dead-link: xref:chmod.adoc[chmod command]
Sometimes, you may get an error message saying something like "permission denied". Any file that you want to run must be _executable_. To make a file executable, you can use the chmod command.
