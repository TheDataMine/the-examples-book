...
+
image::gradient-descent-1.jpg[Overview of Gradient Descent Algorithm, loading=lazy, title="Overview of Gradient Descent Algorithm"]
+
...
use a python file or ipynb notebook