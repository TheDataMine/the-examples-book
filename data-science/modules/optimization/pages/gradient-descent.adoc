...
[NOTE]
====
`torch.manual_seed(1)` helps in tracking the reproducibility of experiments involving stochasticity (randomization) in PyTorch. One instance of which is weights initialization while creating models.
====
