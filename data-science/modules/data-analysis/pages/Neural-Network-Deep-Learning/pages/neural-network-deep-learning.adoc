...
Neural networks originally were used to solve pattern recognition problems (like the MNIST dataset, which can be found in the code projects below). Neural networks tend to benefit in predictive/inferential power as datasets get larger. 

Computer vision problems (especially in a healthcare context), classification problems, and speech & natural language processing have all seen intensive use of neural networks in the past 20 years.
