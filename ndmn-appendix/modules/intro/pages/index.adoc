...
<div class="panel">
  <ul>
  <li>The <a href="https://the-examples-book.com/crp/" target="_blank">Corporate Partners Program</a> is a experiential learning student experience course featuring data driven projects from industry.</li>
