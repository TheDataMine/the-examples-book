...
<div class="panel">
  <ul>
    <li>The National Data Mine Network(NDMN) is an NSF funded grant in collaboration with the <a href="https://www.amstat.org/">American Statistical Association</a> to enable undergraduate students at MSIs to learn data science with hands-on work in research or data science projects by industry partners</li>
