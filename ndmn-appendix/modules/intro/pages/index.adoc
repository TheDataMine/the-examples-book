...
<div class="panel">
  <ul>
    ...
    <a href="https://the-examples-book.com/crp/students/ds_team_support" target="_blank">support</a>
    , training, <a href="https://the-examples-book.com/starter-guides/tools-a" target="_blank">materials/tools</a>
