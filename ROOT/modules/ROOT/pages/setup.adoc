...
Welcome to The Data Mine! To get started, you need to set up a few accounts.

Some NOTES before you start:

[IMPORTANT]
====
If you took one of the TDM seminar courses or worked on a corporate projects last semester (Fall 2025), you do not need to complete these steps again. You may simply close the page.
====

[NOTE]
====
Everyone who will work on seminar and/or corporate projects, regardless of their role, (mentors, students and TAs), must have an **ACCESS** account and complete **all the steps** we will outline shortly.

Since the information you enter into TDMHub is automatically pulled to add you to our computational environment, please be **extra** careful when entering your ACCESS username and email address.

Completing these steps is required to connect to Anvil, our supercomputer environment. If you also work on corporate projects, it is additionally necessary for gaining access to the corporate directories.
====
...
*   If you created an ACCESS account before, you do *not* need to do it again. You can go to <<step-2-join-hub, Step 2>>.
...
[NOTE]
====
Please use your institutional email address for ACCESS and add all the required information to your profile:

**Institution or organization** (your own institution, not Purdue, unless you are a Purdue student)

(If you cannot find your organization in the list, you can request that it be added on the same page.)
...
Dr. Ward suggests you use the https://www.firefox.com[Firefox] browser on a computer for all steps.
...
- *Mentors:* Be sure to check the email you gave to The Data Mine staff. If you are still not receiving the email after checking spam and any other filtering system at your institution, please contact to your project liaison or please submit a ticket by emailing datamine-help@purdue.edu with a detailed description of what you are experiencing, and what you've tried.  
...
+
Click the link in the email. Use Firefox (private window, if necessary) to open the link. A web page will open. Click the button to accept the invitation.
+
.Screenshot
