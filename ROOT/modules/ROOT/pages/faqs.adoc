...
* xref:crp:students:index.adoc[Corporate Partners Student Resources]
** Any questions about the course, registration, TA's, due-dates, or the course in general. 
// dead-link: xref:starter-guides:data-science:intro-to-ds:intro-to-data-science.adoc[Data Science]
* Data Science
** Topics related to algorithms, exploratory data analysis, or working with data. 
// dead-link: xref:starter-guides:data-engineering:intro-to-data-engineering:introduction-data-engineering.adoc[Data Engineering]
* Data Engineering
** Questions related to containers, research computing, or data pipelines. 
* xref:tools:python:index.adoc[Programming Languages]
...
// dead-link: https://www.rcac.purdue.edu/knowledge/weber/run/slurm
* Work with https://www.rcac.purdue.edu/knowledge/slurm[SLURM] to schedule your code. 
