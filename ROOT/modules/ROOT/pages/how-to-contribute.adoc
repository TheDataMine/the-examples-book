...
If you are interested in making a contribution to this book, the first step is to https://the-examples-book.com/starter-guides/tools-and-standards/git/github-desktop[install and configure GitHub Desktop]. Then, use the quick-start links provided below.

[IMPORTANT]
====
We made an example module to help with any new content. It will be under `template-module` in the repo and the example content page can be xref:template-module:ROOT:index.adoc[found here]. Feel free to make a copy and use it for your own module!
====
...
. You've https://the-examples-book.com/starter-guides/tools-and-standards/git/github-desktop[installed and configured GitHub Desktop], and your **Current Repository** (in the upper left-hand corner) is set to the-examples-book. Your screen should look similar to the following.
...
----
+
In the https://github.com/TheDataMine/the-examples-book[primary repository] you will also need to change the https://github.com/TheDataMine/the-examples-book/content/modules/ROOT/pages/index.adoc[`index.adoc`] file add a link on the homepage to your appendix.  For example:
+
[source, yaml]
----
