...
If you are interested in making a contribution to this book, the first step is to https://the-examples-book.com/tools/git/github-desktop[install and configure GitHub Desktop]. Then, use the quick-start links provided below.

[IMPORTANT]
====
// dead-link: xref:template-module:ROOT:index.adoc[found here]
...
. You've https://the-examples-book.com/tools/git/github-desktop[installed and configured GitHub Desktop], and your **Current Repository** (in the upper left-hand corner) is set to the-examples-book. Your screen should look similar to the following.
...
+
. Create and place the desired AsciiDoc content in the `pages` directory.  The index.adoc page will be the landing page for your appendix.  For new high level pages, add lines to the nav.adoc file. If you do create further navigation in nav.adoc, you can then create new .adoc files with the corresponding name in the `pages` directory. Make sure to follow our <<naming-convention, page naming convention>>.
...
----
+
In the https://github.com/TheDataMine/the-examples-book[primary repository] you will also need to change the https://github.com/TheDataMine/the-examples-book[`index.adoc`] file add a link on the homepage to your appendix.  For example:
+
[source, yaml]
----
...
+
[TIP]
Check out this book's https://github.com/TheDataMine/the-examples-book/blob/staging/antora-playbook.yml[`antora-playbook.yml`] file for more details.
...
----
+
<1> This is the name of the core book or appendix. This appears as the first value in our URL's path. For example: \https://the-examples-book.com/<version>/<page-name>.
<2> The title of the core book or appendix. This typically appears to the right of the favicon in the browser tab.
<3> The version of the core book or appendix. This appears as the second value in our URL's path. For example: \https://the-examples-book.com/0.1.0/<page-name>.
...
ROOT::
// dead-link: https://github.com/TheDataMine/scholar-appendix[scholar appendix]
...
====
[[naming-convention]]
include::../partials/naming-convention.adoc[]
====
...
Below are a variety of AsciiDoc examples from https://powerman.name/doc/asciidoc[powerman]. To see how content is rendered, compare https://github.com/TheDataMine/the-examples-book[the adoc file for this page], to it's output below.
...
To include an image inline from same module: image:figure01.webp[Alternate text for figure01, height=25, width=25, loading=lazy]

To include an image inline from different module: image:tools:ROOT:data_science_lifecycle.png[Alternate text for data science lifecycle, height=250, width=250, loading=lazy]

==== Block images

To include a block image from the same module:

image::figure01.webp[Alternate text for figure01, height=25, width=25, loading=lazy]

To include a block image from a different module:

image::tools:ROOT:data_science_lifecycle.png[Alternate text for data science lifecycle, height=250, width=250, loading=lazy]
