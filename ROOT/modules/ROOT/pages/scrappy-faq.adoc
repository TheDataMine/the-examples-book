...
// dead-link: xref:howtoregister.adoc[tutorial]
...
* link:https://www.purdue.edu/registrar/[The open registration schedule] is set by Purdue. The exact time of day it opens depends on how many credits you have earned. All students should have access by the end of the day, but the exact time of day will vary student to student. exact time 
...
// dead-link: xref:howtoregister.adoc[How to Register]
