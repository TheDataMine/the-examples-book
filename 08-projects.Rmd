...
**Relevant topics:** [unique](#r-unique), %in%, [any](#r-any), [sapply](#r-sapply), [which](#r-which)
...
**Relevant topics:** [dbGetQuery](#sql), SUM, [SELECT](#sql), [FROM](#sql), [WHERE](#sql)
...
**Relevant topics:** dbGetQuery, [AND/OR](#sql), [COUNT](#sql), [SUM](#sql)
...
**Relevant topics:** dbGetQuery, [ORDER BY](#sql), [BETWEEEN](#sql)
...
**Relevant topics:** dbGetQuery, [DISTINCT](#sql), [COUNT](#sql)
...
**Relevant topics:** dbGetQuery, [AND/OR](#sql), [DISTINCT](#sql), [COUNT](#sql)
...
**Relevant topics:** dbGetQuery, [plotting in R](#r-plotting), [COUNT](#sql)
...
**Relevant topics:** [sql](#sql), [aliasing](#sql-aliasing), [concat](#cat)
...
**Relevant topics:** [inner join](#sql-groupby)
...
**Relevant topics:** [inner join](#sql-groupby), [aliasing](#sql-aliasing)
...
**Relevant topics:** [RMariaDB](#sql), [dbConnect](#sql), dbGetQuery
...
**Relevant topics:** dbGetQuery, SUM, [SELECT](#sql), [FROM](#sql), [WHERE](#sql)
...
**Relevant topics:** dbGetQuery, [AND/OR](#sql), [COUNT](#sql), SUM
