...
**Relevant topics:** [for loop](#r-for-loops), [read.csv](#r-reading-and-writing-data), [pie](#r-pie), [table](#r-table)
...
attributes of the airbnb listings.
```{r, echo=F}
hawaii_calendar <- read.csv("http://llc.stat.purdue.edu/listings.csv.gz")
```
...
`reviewer_name`, and `comments`
```{r, echo=F}
hawaii_calendar <- read.csv("http://llc.stat.purdue.edu/reviews.csv.gz")
```
