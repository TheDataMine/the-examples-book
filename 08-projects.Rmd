...
##### 2. Using the new `accidents` data you created in question1, how many accidents are there where 1+ drunk drivers were involved in an accident with a school bus?
...
##### 4. Calculate the mean number of motorists involved in an accident (variable `PERSON`) with i drunk drivers where i take the values from 0 through 6.
