...
2. If it is a project containing R code, a .R file containing all of the R code.
...
**Important note:** For this question, we want you to submit the modified version of the inserted 
