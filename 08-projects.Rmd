...
##### 4. Follow the directions [here](#r-ggmap) to install `ggmap` and get an API key. There are over 4 million rows in our dataset -- we do _not_ want to hit Google's API that many times, nor would that work. Instead, do the following:
