...
- Create an new variable containing the `STATE` column (from the `dat` dataset) converted to a factor.
...
**Relevant topics:** [as.factor](#r-as.factor), [order](#r-order), [levels](#r-levels), [in](#r-%in%)
...
**Relevant topics:** [tapply](#r-tapply), [which.max](#r-which.max)
