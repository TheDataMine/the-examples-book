...
```{r, echo=F}
hawaii_calendar <- read.csv("http://llc.stat.purdue.edu/calendar.csv.gz")
```
...
```{r, echo=F}
hawaii_listings <- read.csv("http://llc.stat.purdue.edu/listings.csv.gz")
```
...
```{r, echo=F}
hawaii_reviews <- read.csv("http://llc.stat.purdue.edu/reviews.csv.gz")
```
