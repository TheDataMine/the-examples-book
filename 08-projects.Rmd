...
##### 1. Load up the following two datasets `goodreads_books.csv` and `goodreads_book_authors.csv`into two data.frames `books`, and `authors`, respectively. Then read in only 1 million rows of the `goodreads_interactions.csv`dataset into a data.frame called `interactions`. How many columns and rows are in each of the three datasets?
