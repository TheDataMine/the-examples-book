...
##### 4. In project (8) we created a function called `count_words`. Use this function and `sapply` to create a vector with the length (in words) of the questions. Add a new column called `question_length` to our question data.frame that contains these word counts.
