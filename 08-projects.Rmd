...
**Note:** A Megabyte (MB) is actually 1000^2 bytes, not 1024^2. A Mebibyte (MiB) is 1024^2 bytes. See [here](https://en.wikipedia.org/wiki/Gigabyte) for more information. For this question, either solution will be given full credit.
