...
##### The data in that folder has been added to the `elections` database, all aggregated in the `elections` table. Write a SQL query that returns the number of rows of data are in the database. How many rows are in the table `elections`?
...
##### The data we consider in this project are much larger. Use UNIX utilities to write another line of code that calculates the total amount of data in the elections folder `/class/datamine/data/election/`. How much data (in MB) is there?
