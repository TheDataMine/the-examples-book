...
In the example below the function `Fun` is the median and we have two vetors/groups of `beer_id`s passed with c(271781) being group 1 and c(125646, 82352) group 2.
Example:
```{r, eval=F}
