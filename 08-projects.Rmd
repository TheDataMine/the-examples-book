...
##### 3. Calculate the Batting Average of batters between 2000 and 2010, with more than 300 at-bats (ABs). List the top 5 batting averages next to the `playerID` (with team and year). Batting Averages are calculated as $\frac{H}{AB}$.
