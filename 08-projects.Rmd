...
##### What percentage of questions have 1, 2, 3, and 4 options? Create a new column in the `questions` dataset called `number_options` which contain the number of answer options for each question.
