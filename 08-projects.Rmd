...
##### 3. You can access many elements in a vector at the same time. Create three new vectors named: `first50`,  `last50`, and `mix`. The vector `first50` should contain the first 50 values of `our_vec`vector we created in the previous question, and `last50` should contain the last 50 values. The vector `mix` should contain the value resulting from each element of `first50` being added to each element of `last50`.
