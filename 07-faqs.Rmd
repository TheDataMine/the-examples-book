...
There are a variety of ways to connect to Scholar from off-campus. If you just want to use Jupyter notebooks, you can [use JupyterHub](#jupyterhub). If you just want to use RStudio, you can [use RStudio Server](#rstudio-server).
