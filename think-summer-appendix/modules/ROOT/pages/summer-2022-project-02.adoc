...
We've provided you with a template notebook for you to use. Please carefully read xref:think-summer-appendix:ROOT:summer-2022-project-template.adoc[this section] to get started.
