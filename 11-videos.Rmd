# Video option 1: embedded youtube
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/fIwhGmwMK7E?start=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
`r ''````{r declare-variable-290-v, eval=FALSE}
my_variable <- c(1,2,3)
```
...
```{r my-new-install-packages-290-v, eval=F}
plot(my_variable)
```
...
```{r my-new-install-packages-390-v, eval=F}
plot(my_variable)
```
