...
Inside the Inspector tab, I'll minimize the row until I reach the table consiting of all games. 

image::MP7_PopOut.png[Locating the board game table in the Inspector Tab, width=620, height=480, loading=lazy, title="Locating the board game table in the Inspector Tab"]
