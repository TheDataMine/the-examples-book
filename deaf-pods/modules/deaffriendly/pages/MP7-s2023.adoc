...
Make sure to read about and use the template found https://the-examples-book.com/projects/templates[here]. Also make sure to read the important information about projects submissions https://the-examples-book.com/projects/submissions[here].
...
Here's a xref:workshops:gallygoogle:webscraping.adoc#what-are-websites-are-made-of[brief summary about website structures]. *It's important to take some time to read and review it as this will help you understand and do your Project 7*
...
Reminder: Please review this xref:workshops:gallygoogle:webscraping.adoc#what-are-websites-are-made-of[brief summary about website structures].
