...
image::figure01.webp[Post submit screen, width=792, height=500, loading=lazy, title="Post submit screen"]

Click on the button in the upper right-hand corner named "Code". 

image::figure02.webp[Click "Code", width=792, height=500, loading=lazy, title="Click Code"]
...
image::figure03.webp[Double check rendered notebook, width=792, height=500, loading=lazy, title="Double check rendered notebook"]
