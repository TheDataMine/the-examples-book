...
. Log-in with you XSEDE credentials that you set up previously. 
...
[TIP]
====
Pay careful attention to your time. Once the time runs out the session will end and you cannot save any new changes. 
====