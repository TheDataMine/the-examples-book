...
. Open your favorite browser, we usually use Chrome of Firefox, and navigate to ondemand.anvil.rcac.purdue.edu. 
...
== Helpful Tips
* It's helpful to create a symlink to your team's folder in Jupyter Lab. 
** To do this open a cell in Jupyter Lab and update the code below with your team's file path. 
** *NOTE* You only need to run this command once. If you run it more than once Anvil will get angry. 
+
[source, bash]
----
%%bash
ln -s /anvil/tdm/projects/corporate/team-name $HOME/team-name
----