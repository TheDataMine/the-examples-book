...
Example: We've read in the data and checked it out, but the CEO wants a heatmap that shows each ride any the number of denials that the system has. They are looking to understand if there is a specific ride that appeals more to children who are then turned away and have a bad experience. 
