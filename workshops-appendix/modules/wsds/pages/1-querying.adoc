...
2.0 Now focus on the `People` table. 

2.1. How many columns are in the `People` table?

2.2. What is the name of the column that contains the player’s first name?

2.3. For a players deathYear, what is put in the column if the player is still alive?

2.4. What is Don Aase’s playerID?
