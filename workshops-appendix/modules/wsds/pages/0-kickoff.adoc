...
[Warning]
====
Maggie still needs db diagram. 

====

We will use the link:http://seanlahman.com/[Lahman Baseball Database]. The SQLite database on Anvil is located at `/anvil/projects/tdm/data/lahman/lahman.db`. 

We will use the Lahman data for all *practice on your own* content. 

The following is an illustration of the database to help you understand the data.

image::lahmandb.png[Database diagram from https://dbdiagram.io, width=792, height=500, loading=lazy, title="Database diagram from https://sabr.org/lahman-database/"]
