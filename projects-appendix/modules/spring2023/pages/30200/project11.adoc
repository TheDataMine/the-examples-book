...
two_x_squared(4.0) # 32.0
two_x_squared(my_array) # [2.0, 8.0, 18.0]
deriv(4.0) # 16.0
deriv(my_array) # uh oh! Something went wrong!
----
...
[source,python]
----
vectorized_deriv_squared = jax.vmap(deriv)
