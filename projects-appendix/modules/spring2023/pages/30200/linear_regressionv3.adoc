...
image::Regression_Line_Spotify.jpg[width=600, height=450, caption="Simple Linear Regression Plot Spotify Data"]
...
image::Normality_assumption_histogram.jpg[width=600, height=450, caption="Normality Test Histogram Spotify Data"]
...
image::fitted_vs_res_spotify.jpg[width=600, height=450, caption="Fitted vs Residuals Plot Spotify Data"]
