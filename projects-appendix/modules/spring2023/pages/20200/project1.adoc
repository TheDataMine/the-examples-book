...
. Read the https://the-examples-book.com/tools/html[HTML section of the book].
. Read through the https://the-examples-book.com/tools/xml[XML section of the book].
...
[TIP]
====
Check out xref:spring2022:29000/project1.adoc[this old project] that uses a different dataset -- you may find it useful for this project.
====
...
First, try to use the same method from question (2) from xref:spring2022:29000/project1.adoc[this project] to find the next tier of names. What happens?
