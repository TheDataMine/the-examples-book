...
[TIP]
====
We have written several examples to get you started with functions https://the-examples-book.com/tools/python/writing-functions[here].  All 6 of the videos for this project are given at the top of this page.  At the beginning, you probably only need to read the section on https://the-examples-book.com/tools/python/writing-functions#arguments[Arguments].
====
