...
[TIP]
====
We have written several examples to get you started with functions https://the-examples-book.com/tools/python/writing-functions[here].  All 6 of the videos from Project 5 are given at the top of this page.
====

[TIP]
====
UPDATE: WE ADDED 3 MORE VIDEOS FOR PROJECT 6, which are given under https://the-examples-book.com/tools/python/writing-functions#new-videos-for-project-6[the heading Project 6 videos in this section].
====
