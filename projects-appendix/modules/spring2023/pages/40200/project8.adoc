...
[TIP]
====
// dead-link: https://github.com/tiangolo/fastapi/issues/854[this]
https://fastapi.tiangolo.com/tutorial/request-forms/#define-form-parameters[This] and this will likely be helpful.
====
