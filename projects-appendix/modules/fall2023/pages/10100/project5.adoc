...
Make sure to read about, and use the template found xref:ROOT:templates.adoc[here], and the important information about projects submissions xref:ROOT:submissions.adoc[here].
...
In addition, please review our xref:ROOT:submissions.adoc[submission guidelines] before submitting your project.
====
