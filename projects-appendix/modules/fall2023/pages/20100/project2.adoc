...
**Relevant topics:** https://the-examples-book.com/tools/unix/pwd[pwd]
...
https://the-examples-book.com/tools/unix/pwd[pwd], https://the-examples-book.com/tools/unix/cd[cd], https://the-examples-book.com/tools/unix/ls[ls]
...
**Relevant topics:** https://the-examples-book.com/tools/unix/pwd[pwd], https://the-examples-book.com/tools/unix/cd[cd], https://the-examples-book.com/tools/unix/special-symbols[special-symbols]
...
Sometimes, you may want to know what the first or last few lines of your file look like.  https://the-examples-book.com/tools/unix/head[head] and https://the-examples-book.com/tools/unix/tail[tail] can help us do that. Take a look at their documentation to learn more.

One goal of our programs is often to be size-efficient. If we have a very simple program, but it is enormous, it may not be worth our time to download and use. The https://the-examples-book.com/tools/unix/wc[wc] tool can help us determine the size of our file. Take a look at its documentation for more information.
...
Finally, we often may know that a program exists, but we don't know where it is. https://the-examples-book.com/tools/unix/which[which] can help us find the location of a program. Take a look at its documentation for more information, and use it to solve the last part of this question.
...
**Relevant topics:** https://the-examples-book.com/tools/unix/pwd[pwd], https://the-examples-book.com/tools/unix/cd[cd], https://the-examples-book.com/tools/unix/head[head], https://the-examples-book.com/tools/unix/tail[tail], https://the-examples-book.com/tools/unix/wc[wc], https://the-examples-book.com/tools/unix/which[which], https://the-examples-book.com/tools/unix/type[type]
...
**Relevant topics:** https://the-examples-book.com/tools/unix/cp[cp], https://the-examples-book.com/tools/unix/rm[rm], https://the-examples-book.com/tools/unix/touch[touch], https://the-examples-book.com/tools/unix/cd[cd]
