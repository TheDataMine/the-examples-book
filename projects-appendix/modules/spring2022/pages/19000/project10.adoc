...
Carefully read through xref:tools:python:classes.adoc[this] quick walkthrough of classes in Python. In previous 190 projects, students built classes to represent decks of cards. Now, we've provided you with a couple of classes below.
