...
Use one of the https://pandas.pydata.org/docs/reference/frame.html#attributes-and-underlying-data[attributes] from your DataFrame in combination with xref:tools:python:printing-and-f-strings.adoc[f-strings] to print the following:
