...
Okay, there are a couple of other different modifications in the script. Carefully read through the code, and give you best explanation of the changes in 2-3 sentences. Add another 1-2 sentences with your opinion of the changes.
