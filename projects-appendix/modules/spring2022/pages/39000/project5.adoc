...
To properly save screenshots in your Jupyter notebook, follow the guidelines xref:templates.adoc#including-an-image-in-your-notebook[here]. Images that don't appear in your notebook in Gradescope will not get credit.
====
