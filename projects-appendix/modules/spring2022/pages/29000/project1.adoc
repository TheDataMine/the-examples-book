...
[WARNING]
====
Please review our updated xref:projects:ROOT:submissions.adoc[submission guidelines] before submitting your project.
====

[TIP]
====
// dead-link: https://thedatamine.github.io/the-examples-book/projects.html#p01-290[here]
For this project, you may find the questions and solutions of an old project found here useful.
====

[TIP]
====
You should read through the small xref:tools:ROOT:xml.adoc[XML section] of the book.
====
...
// dead-link: https://thedatamine.github.io/the-examples-book/projects.html#p01-290[this project]
