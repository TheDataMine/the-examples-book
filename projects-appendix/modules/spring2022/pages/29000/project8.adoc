...
Read https://realpython.com/python-main-function/[this article] about the `main` function in Python scripts. Also, please read https://realpython.com/run-python-scripts/#using-the-script-filename[this section], paying special attention to the shebang. Lastly, read xref:tools:unix:scripts.adoc#shebang[this section].
