...
// dead-link: https://thedatamine.github.io/the-examples-book/r.html#r-facet_wrap[`facet_wrap`]
Question 4 is a bit tedious. `tidyverse` provides a _much_ more ergonomic way to create plots like this. Use `facet_wrap` to create the same plot.
