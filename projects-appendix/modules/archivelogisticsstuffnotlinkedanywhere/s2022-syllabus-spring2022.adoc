...
• *T.A.s:* Visit their xref:spring2022:officehours.adoc[office hours] and use the link:https://piazza.com/[Piazza site]
...
The xref:spring2022:officehours.adoc[office hours schedule is posted here.]
