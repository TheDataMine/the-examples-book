...
This dataset contains information about the applications available on the Google Play Store. This data includes 10k play store apps for analyzing the Android market.