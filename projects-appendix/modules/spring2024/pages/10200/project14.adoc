= TDM 10200: Project 14 -- Spring 2024
...
.. While working on the projects, including loops, functions, and classes, what steps did you take to ensure that the results were right? Please illustrate your approach using an example from one problem that you addressed this semester.
...
.. Please identify 3 skills or topics related to the Python language that you want to learn in the future. For each, please provide an example that illustrates your interests, and the reason that you think they would be beneficial.  
