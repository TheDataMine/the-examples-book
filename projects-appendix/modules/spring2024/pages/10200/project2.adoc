...
* Make sure to read about, and use the template found xref:ROOT:templates.adoc#option-1[here], and the important information about projects submissions xref:ROOT:submissions.adoc[here].
...
- https://the-examples-book.com/tools/python/tuples[Python tuples]
- https://the-examples-book.com/tools/python/lists[Python lists]
- https://the-examples-book.com/tools/python/pandas-dataframes[Python pandas DataFrames] 
- https://the-examples-book.com/tools/python/matplotlib[matplotlib]
...
.. Use a https://the-examples-book.com/tools/python/pandas-dataframes#dataframe-constructor[DataFrame Constructor] to convert `mydata` into a DataFrame named `studentDF`.
...
[TIP]
====
We added a https://the-examples-book.com/tools/python/pandas-dataframe-constructor[video about using the Pandas Data Frame Constructor]
====
...
We added a video about https://the-examples-book.com/tools/anvil/starting-an-anvil-session[starting an anvil session with more cores]
====
...
[TIP]
====
We added a two part video about making such a bar chart.  See the https://the-examples-book.com/tools/python/pandas-breweries-examples#part-1-video[part 1 video] and the https://the-examples-book.com/tools/python/pandas-breweries-examples#part-2-video[part 2 video].  Note:  The example videos are about the number of reviews per user (instead of the number of vehicles per state), but the method is the same, and these videos should help to guide your work on Question 5.
====
