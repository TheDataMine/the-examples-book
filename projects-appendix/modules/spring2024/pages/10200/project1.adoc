...
====
Login to Anvil.
Navigate and login to https://ondemand.anvil.rcac.purdue.edu using your ACCESS credentials (and Duo Mobile). You may refer to https://the-examples-book.com/tools/anvil/[Anvil Introduction] and https://the-examples-book.com/tools/anvil/access-setup[Access Setup] to find out how to Login to Anvil.
====
...
We added a video about https://the-examples-book.com/projects/templates#running-python-code-using-the-seminar-kernel[Running Python code using the seminar kernel]
====
...
[TIP]
====
We made a https://the-examples-book.com/tools/python/inputtingdata[video about inputting data into Python in a Jupyter Lab session]
====
...
[TIP]
====
We added a https://the-examples-book.com/tools/python/pandas-shape[video about the shape of Pandas Data Frames]
====
...
[TIP]
====
We added a video about https://the-examples-book.com/projects/submissions#how-to-make-a-python-file[How to make a Python file]
====
