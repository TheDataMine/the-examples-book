...
// dead-link: xref:data-modeling/process/eda.adoc[looked at it to confirm its approximate properties and condition]
// dead-link: xref:data-modeling/process/wrangling.adoc[We've gotten ahold of our data]
// dead-link: xref:data-modeling/process/think-output.adoc[and thought about what our output should look like]
...
// dead-link: xref:data-modeling/process/think-output.adoc[output]
...
// dead-link: xref:data-modeling/resampling-methods/cross-validation/train-valid-test.adoc[training, validation, and testing splits]
...
// dead-link: xref:data-modeling/general-principles/bias-variance-tradeoff.adoc[overfitting]
...
// dead-link: xref:data-modeling/general-principles/curse-of-dimensionality.adoc[see the power of PCA notebook example for a demonstration of how to use PCA]
...
$L_1$ https://developers.google.com/machine-learning/crash-course/regularization-for-sparsity/l1-regularization[is often used] for sparsity or Curse of Dimensionality.

// dead-link: xref:data-modeling/general-principles/bias-variance-tradeoff.adoc[overfitting]
$L_2$ https://developers.google.com/machine-learning/crash-course/regularization-for-simplicity/l2-regularization[is often used] to prevent overfitting.
...
TIP: These are code examples in the form of Jupyter notebooks running in a container that come with all the data, libraries, and code you'll need to run it. https://the-examples-book.com/tools/anvil/using-data-mine-containers[Click here to learn why you should be using containers, along with how to do so.]
