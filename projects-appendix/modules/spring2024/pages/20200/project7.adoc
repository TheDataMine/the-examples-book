...
- xref:tools:unix:vscode.adoc[Visual Studio Code Starter Guide]
...
https://the-examples-book.com/tools/python/making-VS-Code-work-in-Anvil-and-Using-Dash-apps
====
...
[loweralpha]
.. Following the instructions on xref:tools:unix:vscode.adoc[Visual Studio Code Starter Guide], launch VS Code on Anvil
.. Following the instructions on xref:tools:unix:vscode.adoc[Visual Studio Code Starter Guide], including the Initial Configuration of VS Code, and install the Python extension for Visual Studio
.. Following the instructions on xref:tools:unix:vscode.adoc[Visual Studio Code Starter Guide], select the Python interpreter path to `/anvil/projects/tdm/apps/lmodbin/python-seminar/python3`
