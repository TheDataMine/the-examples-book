...
- https://spark.apache.org/docs/latest/api/python/index.html[PySpark Documentation]
====

[IMPORTANT]
====
We added https://the-examples-book.com/tools/python/hints-for-TDM-20200-project-9[five new videos] to help you with Project 9.
====
...
- Refer to https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/api/pyspark.sql.DataFrame.withColumn.html[.withColumn]
====
