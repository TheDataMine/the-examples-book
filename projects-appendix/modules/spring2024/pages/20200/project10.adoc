...
// dead-link: https://scikit-learn.org/stable/tutorial/[scikit-learn tutorial]
...
[IMPORTANT]
====
We added https://the-examples-book.com/tools/python/hints-for-TDM-20200-project-10[five new videos] to help you with Project 10.  BUT the example videos are about a data set with beer reviews.  You need to (instead) work on the flight data given here:  `/anvil/projects/tdm/data/flights/2014.csv`
====
