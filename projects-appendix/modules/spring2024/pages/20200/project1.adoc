...
Please checkout https://the-examples-book.com/tools/python/lxml[this] Example Book lxml introduction.
====
...
https://the-examples-book.com/tools/python/lxml-otc-examples[`lxml` examples with the `otc` data set]

These examples can be especially helpful for you as you work on Project 1.

We also added https://the-examples-book.com/tools/python/lxml-examples-TDM-20200-Project1-Spring-2024[5 more videos for you, which are specifically about Project 1]
