...
.Items to submit
====
See https://the-examples-book.com/projects/templates#including-an-image-in-your-notebook[here] on how to properly include a screenshot in your Jupyter notebook. If you do _not_ properly submit the screenshot, you will likely lose points, so _please_ take a minute to read it.
