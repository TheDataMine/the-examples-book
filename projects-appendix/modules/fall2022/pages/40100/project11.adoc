...
[TIP]
====
Use this trick: https://the-examples-book.com/tools/xml#write-an-xpath-expression-to-get-every-div-element-where-the-string-abc123-is-in-the-class-attributes-value-as-a-substring for finding and clicking the “see more” buttons for the two tables. If you dig into the HTML, you will see that there is some text that you can use, to jump directly to the two tables.
