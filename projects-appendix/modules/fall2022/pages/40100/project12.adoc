...
Implement the `get_links`, and `link_to_blob` functions using `playwright` instead of `selenium`. You can find the documentation for `playwright` https://playwright.dev/python/docs/intro[here].
