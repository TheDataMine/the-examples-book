...
[WARNING]
====
For any questions requiring a screenshot be included in your notebook, follow the method described https://the-examples-book.com/projects/templates#including-an-image-in-your-notebook[here] in order to add a screenshot to your notebook.
====
