...
[TIP]
====
Read the https://the-examples-book.com/tools/unix/scripts#shebang[shebang] and https://the-examples-book.com/tools/unix/scripts#arguments[arguments] sections in the book.
====
