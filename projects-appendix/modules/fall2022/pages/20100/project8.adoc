...
**Relevant topics:** xref:tools:sql:queries.adoc#examples[queries], xref:tools:sql:queries.adoc#using-the-sqlite-chinook-database-here-select-the-first-5-rows-of-the-employees-table[useful example]
...
**Relevant topics:** xref:tools:sql:queries.adoc#examples[queries], xref:tools:sql:queries.adoc#using-the-sqlite-chinook-database-here-select-only-employees-with-the-first-name-steve-or-last-name-laura[useful example]
