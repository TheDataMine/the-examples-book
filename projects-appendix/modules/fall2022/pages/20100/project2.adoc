...
// dead-link: xref:tools:unix:echo.adoc[echo]
**Relevant topics:** xref:tools:unix:pwd.adoc[pwd], xref:tools:unix:cd.adoc[cd], echo, xref:tools:unix:ls.adoc[ls]
...
**Relevant topics:** xref:tools:unix:pwd.adoc[pwd], xref:tools:unix:cd.adoc[cd], xref:tools:unix:special-symbols.adoc[. & .. & ~]
...
// dead-link: xref:tools:unix:du.adoc[du]
**Relevant topics:** xref:tools:unix:pwd.adoc[pwd], xref:tools:unix:cd.adoc[cd], xref:tools:unix:head.adoc[head], xref:tools:unix:tail.adoc[tail], xref:tools:unix:wc.adoc[wc], du, xref:tools:unix:which.adoc[which], xref:tools:unix:type.adoc[type]
...
**Relevant topics:** xref:tools:unix:cp.adoc[cp], xref:tools:unix:rm.adoc[rm], xref:tools:unix:touch.adoc[touch], xref:tools:unix:cd.adoc[cd]
