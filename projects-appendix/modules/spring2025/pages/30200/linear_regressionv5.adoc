...
_Note: The function has been provided. Your task is to run it succesfully and then write 1-2 sentences about feature selection._
...
== References
Some explanations in this project have been adapted from authoritative sources in statistics and machine learning, as listed below. 
