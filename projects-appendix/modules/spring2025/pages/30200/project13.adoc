= TDM 30200: Project 13 -  Large Language Models (LLMs): Transformers and Mini-LLM
...
print(y[0][0][:10]) # Should output `tensor([-0.0573,  0.2174, -0.1701, -0.1619,  0.2006, -0.3761,  0.0768,  0.0381, -0.0810,  0.0113], grad_fn=<SliceBackward0>)`
----
