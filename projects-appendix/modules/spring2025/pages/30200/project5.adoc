...
# the cv2.ml.ROW_SAMPLE flag tells OpenCV that the samples are in rows, not columns. This is the default for numpy arrays, but we need to specify it here.
