...
Now run your function from Question 3 on each of the 56 elements in the list named `mystatelist`.  In this way, you should create a list of 56 data frames, one for each state.
