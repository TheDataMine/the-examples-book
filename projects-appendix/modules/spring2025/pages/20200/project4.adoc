...
Make a visualization about something that you find interesting from the National Park data, either using your work from Project 3 or Project 4; any visualization is OK.
