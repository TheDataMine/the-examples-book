...
.Deliverables
====
- Show the results from running the function `myscrapingfunction` on each element of `mylistofurls`.  It is not necessary to give all of the output; for instance, the head of the resulting list is sufficient to show.
