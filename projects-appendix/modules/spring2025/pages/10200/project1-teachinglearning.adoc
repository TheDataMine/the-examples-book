...
We can select rows of the data frame that meet certain conditions.  For instance, we can extract the aiports located in New York City as follows:
...
and then the `value_counts` function gives the number of airpots in each state:
