...
[NOTE]
====
 You can read about confidence intervals from the following https://www.nlm.nih.gov/oet/ed/stats/02-950.html[NIH page] which explains it very very briefly. 
====
