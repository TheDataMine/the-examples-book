...
- If $\lambda \goes 0$, the estimated parameter values converge to those obtained from ordinary least squares.  
- If $\lambda \goes \infinity$, the ridge regression coefficients shrink toward zero.
