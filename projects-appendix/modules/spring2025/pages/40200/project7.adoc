...
The following video briefly give motivation for SVM:
...
The Python code below produce one of the hand-written digits:
...
image::Handwritten[width=300, height=150, title="Example Hand-written Digit"]
