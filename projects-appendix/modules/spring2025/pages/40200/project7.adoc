...
Another method used for cross-validation is *bootstrapping*. Soyle biseyler yaz

Bootstrapping aslinda temel baska amaclarla kullanilmis

Ancak cross validation icin su sekilde kullanilabilir

Simdi baska bir kumeleme ornegi icin kullanalim
