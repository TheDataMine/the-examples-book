...
Unless otherwise specified, all projects will need 1 submitted file:
...
In the case that other files are required in the assignment, the below sections of this page will elucidate how you can make a different file type, along with how you can download a notebook and double-check that your submiddion was processed correctly.
