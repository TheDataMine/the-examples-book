...
The xref:spring2024/logistics/office_hours.adoc[office hours schedule is posted here.]
...
xref:spring2024/logistics/schedule.adoc[Click here to view the Spring 2024 Course Schedule]
...
=== xref:spring2024/logistics/syllabus_purdue_policies.adoc[Purdue Policies & Resources]
