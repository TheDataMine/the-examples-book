...
|===      
include::current-projects:example$10200-2024-projects.csv[]
|===
...
=== Sign up
// Need to replace Piazza Links (Maybe?)
...
Navigate to the xref:spring2024/logistics/syllabus.adoc[syllabus].
