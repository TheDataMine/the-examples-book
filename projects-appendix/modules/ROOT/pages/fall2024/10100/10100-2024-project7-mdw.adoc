...
- c. Same table output as in parb b but now also adding labels corresponding to the 5 categories above.  (It is not necessary to put a label on the unknown age category.)
