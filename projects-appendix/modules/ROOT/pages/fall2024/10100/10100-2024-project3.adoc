...
Find the average height of the athletes in each sport (the sport is the `Sport` column, of course!).  Sort your results.  In which sport are the athletes the tallest (on average)?  Does this make sense intuitively, i.e., is height an advantage in this sport?
