...
image::10100-2024-p1-1.png[OnDemand Jupyter Lab, width=792, height=500, loading=lazy, title="OnDemand Jupyter Lab"]
...
image::10100-2024-p1-2.png[Launch Jupyter Lab, width=792, height=500, loading=lazy, title="Launch Jupyter Lab"]
...
image::10100-2024-p1-3.png[Jupyter Lab Homescreen, width=792, height=500, loading=lazy, title="Jupyter Lab Homescreen"]
...
image::10100-2024-p1-4.png[Question 2 Example Answer, width=792, height=500, loading=lazy, title="Question 2 Example Answer"]
