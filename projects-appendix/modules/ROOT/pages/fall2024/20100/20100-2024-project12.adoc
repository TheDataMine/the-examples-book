...
Join the `flights` and the `carriers` table, matching the `UniqueCarrier` column to the `Code` column.  Find the total number of flights in the database for each `UniqueCarrier`.  For each `UniqueCarrier`, print the `UniqueCarrier` value and also the total number of flights for that `UniqueCarrier`.

.Deliverables
====
- For each `UniqueCarrier`, print the `UniqueCarrier` value and also the total number of flights for that `UniqueCarrier`.
====
