= TDM 30100: Project 04 - Classifiers - Basics of Classification
:page-mathjax: true
...
// dead-link: https://online.stat.psu.edu/stat508/lessons/Lesson01#classification-problems-in-real-life[in section 1.5 here]
