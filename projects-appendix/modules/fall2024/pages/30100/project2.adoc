...
// dead-link: https://the-examples-book.com/tools/choosing-model/[DataMine Examples Book - Choosing a Model]
- DataMine Examples Book - Choosing a Model
...
// dead-link: https://the-examples-book.com/tools/choosing-model/parameterization#splines-as-an-example-of-non-parameterization[read more about splines here]
