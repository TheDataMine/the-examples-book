...
Then, run the following Python in a code cell. For a more in-depth reminder on working in Jupyter, feel free to take a look at xref:10100/project1.adoc[this year's 10100 project 1] or check out https://the-examples-book.com/tools/anvil/jupyter[this guide on Jupyter].
