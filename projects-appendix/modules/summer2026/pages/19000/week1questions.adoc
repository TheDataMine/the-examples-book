...
Consider the RAG pipeline that we talked through on Wednesday, July 15, described in this document:

https://the-examples-book.com/projects/summer2026/19000/rag

11.1 Run the pipeline from start to finish, using The Data Mine document that we provided:  https://datamine.purdue.edu/posters/TDM-Report_2024-4.pdf  and ask the question:  "What is the main idea of this document?"

11.2 Now that you have the pipeline working, change the query at the end of the pipeline, in other words, ask a second question about The Data Mine document.  For instance, you might ask "Which university offers The Data Mine?"  Or you might ask "Who is the professor teaching at The Data Mine?"  Please note that, in questions 11.1 and 11.2, you might get different answers each time!

=== Question 12

Re-run the RAG pipeline again, from start-to-finish, using a different pdf file, i.e., do not use The Data Mine pdf file this time.  Find a file of interest to you!  You might want to choose a short file, i.e., just a few pages, so that you have enough memory for the pipeline to finish.

12.1 Ask a first query about your document.

12.2 Ask a second query about your document.

12.3 Based on these queries, does the LLM represent your document somewhat accurately?
