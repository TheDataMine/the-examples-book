...
*Prerequisites:*
TDM 10100 is an introductory course, with introduction to data analysis in Python, R, SQL.  Students will learn about large language models, agent-based (agentic) models, image processing, containers, APIs, etc.
