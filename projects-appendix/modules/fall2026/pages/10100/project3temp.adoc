...
In this case, R dealt with the error automatically, and Python does not.  We can add the option `errors="coerce"` after the format, and then Python will convert the strings to dates properly.
