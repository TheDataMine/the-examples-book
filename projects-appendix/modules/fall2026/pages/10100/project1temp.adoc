...
Once you have the Beer data loaded in R with the `fread` function, make a table showing how many beers comes from each state.  Sort this table and display the top 6 states, in terms of the number of beers from each state.
...
- Sort this table and display the top 6 states as a , in terms of the number of beers from each state.
