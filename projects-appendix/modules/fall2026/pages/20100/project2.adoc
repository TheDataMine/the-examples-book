...
- Introduction to Text Embeddings and Cosine Similarity

**Motivation:** In Project 2, we learn about embeddings, and also cosine similarity

**Context:** We start to learn about the limitations of LLMs and how to modify the output from queries to LLMs.

**Scope:** Anvil, Jupyter Lab, embeddings, cosine similarity
