...
First, we need to setup the CLIP Model and Processor:  https://the-examples-book.com/projects/fall2026/20100/settingupclip
...
The CLIP Model and Processor will convert the image into vectors using embeddings:  https://the-examples-book.com/projects/fall2026/20100/imageembeddings
