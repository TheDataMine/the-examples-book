...
Create a new llama3.2 model that talks like a pirate.  Ask it a few questions and demonstrate that it can talk like a pirate.

Create another new llama3.2 model that talks like a very grouchy elderly man who does not like people who ask questions.  Ask it a few questions and demonstrate how it talks.
