...
*Prerequisites:*
TDM 10100 is an introductory course, with introduction to data science tools and methodologies.  Students will learn about large language models, agent-based (agentic) models, image processing, containers, APIs, etc.
...
- link:https://piazza.com/purdue/fall2026/tdm10100[*Piazza*] - Online Q/A Forum
- link:https://datamine.purdue.edu[*The Data Mine's website*] - Helpful resource  
- Jupyter Lab via the Notebook Portal on Anvil: https://notebook.anvilcloud.rcac.purdue.edu
