...
- 1b. Create an environment for this project and install everything shown above. (Use run this command in your notebook to show your new environment listed: `!ls /home/{x-username}/.conda/envs/`)
