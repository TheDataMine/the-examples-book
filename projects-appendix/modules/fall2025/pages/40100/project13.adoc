...
The table summarizes the columns and definitions of this data set can be found at the https://the-examples-book.com/projects/fall2025/40100/project13_notready#dataset-overview[end of this project page]. 
