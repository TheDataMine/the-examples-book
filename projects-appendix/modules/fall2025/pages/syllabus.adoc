...
If you use AI tools, you must include an explanation about where you used the AI tools in your work (e.g., you must provide such an explanation in your project template, or in your reporting to your Corporate Partner) describing: * Which tool was used * What it was used for * How the output was modified
====
