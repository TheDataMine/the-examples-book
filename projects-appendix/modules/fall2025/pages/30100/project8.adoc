= TDM 30100: Project 8 - Introduction to Time Series
...
.Deliverables
====
- 5a. Review your temperature column `DailyAverageDryBulbTemperature`. It is currently in Celcius. Convert it to Fahrenheit and name it `DailyAverageDryBulbTemperature_Fahrenheit`.

- 5b. Create a time series plot of daily average temperature `DailyAverageDryBulbTemperature_Fahrenheit` from 2006 to 2024. Write 1–2 sentences describing any trends you observe.
...
- 5c. Create a second plot for `DailyAverageDryBulbTemperature_Fahrenheit` focusing only on the year 2024. Then write 1-2 sentences on- what seasonal patterns or anomalies stand out?
====
