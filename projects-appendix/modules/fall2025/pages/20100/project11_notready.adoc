= TDM 20100: Project 10 - MongoDB Introduction 2 (Advanced)
...
In Project 1, you learned about basic query operators. Now we will apply those same operators to more complex data structures, including arrays and deeply nested objects. The query operators remain the same, but we can now use them in more sophisticated ways.
