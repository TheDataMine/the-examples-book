...
[NOTE]
====
Dr. Ward shows moving some large files in the following video. You can compare your SCRATCH directory space (myquota) with what Dr. Ward says in the video. Is it the same?
