...
[NOTE]
====
For this question, we’ve provided most of the code for you to review and follow. In the code chunk below, you only need to complete the two sections marked `YOUR CODE HERE`.
