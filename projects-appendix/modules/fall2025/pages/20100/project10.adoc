...
[NOTE]
====
Sometimes it might take too long to run, so after a minute or so you can just close the terminal session, open a new one, and rerun the command. It _should_ work almost instantly.
====
...
# Ensure database is clean to avoid duplicate data being added for this question
client.drop_database(db.name)
# Note that you would NOT do this when connecting to a DB normally - this is simply to ensure consistent output for this problem
----
