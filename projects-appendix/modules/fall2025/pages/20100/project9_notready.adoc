= TDM 32100: Project ## - SQL Introduction 5
...
[NOTE]
====
This project primarily uses the Lahman baseball database, but students may also practice with the Chinook music database for additional examples. The Chinook database contains information about music artists, albums, tracks, customers, and sales - providing a different domain to practice the same advanced SQL concepts like triggers, views, and transactions.
====
