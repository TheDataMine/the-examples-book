...
[TIP]
====
Remember, resizing the map is strange and requires the html formatting that we used in https://the-examples-book.com/projects/fall2025/10100/project12#question-2-2-points[Project 12].
==== 
