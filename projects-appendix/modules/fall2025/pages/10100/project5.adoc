...
=== Question 3 (2 points)
Read in the ice cream products file from `/anvil/projects/tdm/data/icecream/combined/products.csv` as `ice_cream`. View the table of the `rating` column. This shows the counts of each rating (from 0 to 5), and is helpful, but there is something else we want to find. 
