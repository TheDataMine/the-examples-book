...
Context: We've worked with the dplyr library before. It is not required, but it interacts very nicely with the leaflet and sf libraries, which makes mapping from manipulated data far less challenging. 
