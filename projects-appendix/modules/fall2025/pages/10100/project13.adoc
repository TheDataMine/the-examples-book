...
[NOTE]
====
We've used `tapply()` in some projects before! In https://the-examples-book.com/projects/fall2025/10100/project7[Project 7], we used `tapply()` similarly to find the average video counts for YouTube channels made within a certain year. 
...
[TIP]
====
Remember, resizing the map is strange (for Firefox browser) and requires the html formatting that we used in https://the-examples-book.com/projects/fall2025/10100/project12#question-2-2-points[Project 12].
==== 
