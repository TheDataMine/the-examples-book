...
[IMPORTANT]
====
For this project, using AI tools is NOT allowed, it is forbidden. We want you to use your own words (it does not matter if you make grammer mmistakes or anything you ask AI to correct it for you). 
...
We would love to have a couple of paragraphs about your Data Mine experience.

.Deliverables
====
1.1 What aspects of The Data Mine made the biggest impact on your academic, personal, and/or professional career? +
1.2 Would you recommend The Data Mine to a friend and/or would you recommend The Data Mine to colleagues in industry, and why? 
1.3 Please indicate (yes/no) whether it would be OK to publish your comments in our forthcoming Data Mine book, webpages, etc.
====

=== Question 2 (2 pts)

This question is around reflecting on your experience working with different datasets.  

.Deliverables
====
2.1 Which dataset did you find most enjoyable, and why? +
2.2 Discuss how this dataset's features influenced your analysis and visualization strategies. +
2.3 Illustrate your explanation with an example from one question that you worked on, using the dataset.
====

=== Question 3 (2 pts)

While working on the projects, how did you validate the results that your code produced?  
...
.Deliverables
====
- A few sentences in a markdown cell on:

4.1 Which questions from projects you found confusing, +
4.2 How they could be written better/more clearly, along with specific examples.
====
...
If there are any final thoughts you have on the course as a whole, be it logistics, technical difficulties, or nuances of course structuring and content that we haven't yet given you the opportunity to voice, now is the time. We truly welcome your feedback! Feel free to add as much discussion as necessary to your project, letting us know how we succeeded, where we failed, and what we can do to make this experience better for all our students and partners.
