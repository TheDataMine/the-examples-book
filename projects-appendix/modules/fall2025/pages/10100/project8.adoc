...
image::ratatouille.gif[width=300, height=250, caption="Source: Pinterest (accessed OCT 7, 2025)."]
...
=== Question 5 (2 points)
In Question 4, we were looking at the _average_ distance per month for each of four flight origins. Use `tapply()` here to find the _total_ (sum) distance per month for each of those same four flight origins. 
