...
*Plot* +
If you Google "ggplot2 plotting", the result can be quite scary. They start throwing words at you like "geom_bar" and "aes" and "facet_wrap", and none of the formatting is familiar. 
