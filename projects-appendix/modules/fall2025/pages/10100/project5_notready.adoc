...
image::TDM_16GB.png[width=200, height=125, title="TDM 16GB", alt="Datamine server with 16 GB option"]
...
image::MyDF_star.png[ title="myDF Star", alt="One line of code reading the data and including star at the beginning of the line"]
