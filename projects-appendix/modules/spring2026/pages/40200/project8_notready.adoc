...
image::mixedmodelsleepstudy.jpg[Days vs Reaction Time, 600, 450, loading=lazy, title="The line plot showing an example of different slopes and intercepts across subjects"]
...
That vertical shift represents the random intercept. In other words, each subject’s line follows the same slope but starts at a different height.  
