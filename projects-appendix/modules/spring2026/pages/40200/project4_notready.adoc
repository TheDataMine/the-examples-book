= TDM 30100: Project ## - Introduction to MLOps
...
.Learning Objectives
****
- Understand what MLOps is and the **importance** of MLOps
...
You'll see its kinda messy. Its not awful, but its only manageable since our project is small right now. Organzing our repo now will make development _way_ easier later on.
