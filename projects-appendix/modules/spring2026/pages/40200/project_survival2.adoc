...
**Why do we take the exponent of log hazard coefficient?**
...
**6b. Choose one continuous predictor from the model (for example, age or ph.karno) and briefly explain whether assuming a linear relationship with the log hazard seems reasonable.
