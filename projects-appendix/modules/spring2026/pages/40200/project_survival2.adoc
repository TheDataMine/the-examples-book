...
**1b. Recode the status variable so that death is labeled as 1 and censored cases are labeled as 0 (assign death= 1 when covid_status = 2 and 0 when covid_status = 1).**
