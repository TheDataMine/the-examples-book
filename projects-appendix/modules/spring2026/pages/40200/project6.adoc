...
image::downsample_example.png[Downsampling, 300, 250, loading=lazy, title="Downsampling wav audio file (Source of the diagram: https://stackoverflow.com/questions/30619740/downsampling-wav-audio-file accessed at 02/22/2026)"]
