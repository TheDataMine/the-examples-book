...
= TDM 40200 Project 10 - Regularization with Lasso and Ridge

== Project Objectives

The objective of this project is to introduce regularization as a way to prevent overfitting and improve model generalization. Students will learn Lasso and Ridge regression and understand the key differences between them. 

.Learning Objectives
****
- Reviewing how a linear regression line is fit by minimizing the sum of squared residuals.

- Recalling what a residual represents and how the sum of squared residuals (SSR) is used to evaluate model fit.

- Learning how regression coefficients are estimated using ridge regression.

- Understanding the role of the penalty term in ridge regression and how it influences coefficient shrinkage.

- Learning how lasso regression estimates coefficients, including how the L1 penalty affects the objective function.

- Distinguishing how linear, ridge, and lasso regression differ in estimating coefficients for a regression problem.
****
