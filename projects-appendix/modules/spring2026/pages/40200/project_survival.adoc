...
- Estimate and compare survival functions using Kaplan–Meier curves overall and across patient subgroups.
...
- Evaluate model assumptions and practical use, checking proportional hazards and linearity assumptions, generating risk scores, and interpreting model results in a real-world context.
****
...
This time is called the **survival time** or **event time** and is usually written as
