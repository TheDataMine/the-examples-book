...
- Simplifies math on the signal (convolutions in time domain are now simple multiplication, please refer the https://dspguide.com/ch9/3.htm[Chapter 9: Applications of the DFT] in 'The Scientist and Engineer's Guide to Digital Signal Processing' book of Steven W. Smith.
...
So far, we have looked at signals in the time domain and frequency domain separately. But what if we want to see how the frequency content changes over time? This is where **spectrograms** come in.
