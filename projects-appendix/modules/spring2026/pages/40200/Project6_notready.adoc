...
[NOTE]
====
The second answer on https://stackoverflow.com/questions/30619740/downsampling-wav-audio-file[Downsampling wav audio file post in stackoverflow] has a good explanation and graphics for downsampling (decimating).
...
image::Fourier_transform.gif[Fourier_transform, 300, 250, loading=lazy, title="Fourier_transform (By Lucas V. Barbosa - Own work, Public Domain, https://commons.wikimedia.org/w/index.php?curid=24830373 accessed at 02/20/2026)"]
