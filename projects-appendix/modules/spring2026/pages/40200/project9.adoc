...
`StratifiedKFold`(see https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.StratifiedKFold.html[here for documentation]) from Scikit-Learn provides train/test indices for splitting data and keeps approximately the same percentage of target class samples as the original dataset. 
