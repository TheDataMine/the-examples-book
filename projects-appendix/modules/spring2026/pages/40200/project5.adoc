...
[IMPORTANT]
====
If you did not complete the previous project and do not want to start from scratch (_not recommended_), the starting point for this project will be available on Thursday Feb 12th in the https://github.com/TheDataMine/intro-mlops-1[intro_mlops_1 GitHub repo] under the 'mlops2_starting_point' folder.
====
