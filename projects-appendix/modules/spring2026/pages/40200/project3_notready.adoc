...
image::containers-vs-virtual-machines.jpg[conatiner vs virtual machine diagram, 600,450, loading=lazy, title="Conatiner vs virtual machine diagram"]
...
image::docker-registry.jpg[docker registry graph, 600, 450, loading=lazy, title="Docker registry graph"]
