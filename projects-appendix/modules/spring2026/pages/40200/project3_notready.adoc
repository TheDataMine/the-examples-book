...
If you have ever worked on some production code then you probably ran that code in some sort of container - likely Docker. Docker is commonly used in industry.
