...
YCbCr is another example of a colour space. The colour information is separated and described by: 

Y is "Luminance" and represents the brightness and the pixel's grayscale information.

Cb and Cr are known as "chrominance" which is the pixel's colour information. 
