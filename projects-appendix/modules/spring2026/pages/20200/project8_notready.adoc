...
Now let’s define an objective function ($f(x)$). The `SciPy`’s `minimize` function will use this function to calculate values of the objective function as it searches for the minimum. You simply need to take the input and return the output.
