...
Welcome back to the TDM course! This semester for 102, we will cover more advanced topics mainly around Phython. We have couple of notes to make this semester easy for you: 

[NOTE]
====
In case you haven't already, visit https://notebook.anvilcloud.rcac.purdue.edu and log in using your ACCESS account credentials. 

If you don't already have an account, follow https://the-examples-book.com/setup[these instructions] to set one up. 
...
Let's start with the basics. We'll work with a simple HTML string and learn how to parse it using `lxml`. First, let's create a simple HTML string and parse it:
