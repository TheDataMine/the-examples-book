...
- 4b. How can PyTorch be useful in doing more complex tasks or more complex matrix multiplication? In what settings is this advantageous? Feel free to do your own research and include more information. 
====
