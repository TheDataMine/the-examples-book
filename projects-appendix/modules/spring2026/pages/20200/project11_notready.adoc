...
We specify `HOME` in case some other tools rely on the environment variable `HOME` - if we did not have it set then the tools may break since they are trying to point to an invalid place.
