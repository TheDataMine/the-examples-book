...
- `apptainer exec` **does not** use the runscript; it runs the command line you give, which is typically preferred for **batch pipelines** where the command should be obvious from the job script.
