...
Let's practice using inspect element. Visit https://quotes.toscrape.com in your browser and (Try with Firefox): +
...
Let's practice scraping another real website. Visit https://the-examples-book.com in your browser and use inspect element to explore its structure:
...
Now, scrape https://the-examples-book.com: +
...
.Deliverables
====
3.1. Visit https://the-examples-book.com and use inspect element to explore its structure. +
