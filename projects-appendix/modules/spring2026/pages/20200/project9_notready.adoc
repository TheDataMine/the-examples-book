...
When you hear about APIs, you will often hear about RESTful APIs. But what is REST? It stands for _Representational State Transfer_ which is a set of standard design principles used for building APIs. Adhering to the standards allows for increased interoperability, increased consistency and increased ease of use. When an API follows REST principles, we call it a RESTful API.
...
.Deliverables
====
* 2-3 sentences explaining what an API is
* 2-3 sentences explaining what REST means and why RESTful APIs are useful
...
* Find a real API (like GitHub, Twitter/X, or any public API) and identify one endpoint that uses each HTTP method (GET, POST, PUT, DELETE). Explain what one of the endpoints does and why that HTTP method makes sense for that operation.
====
