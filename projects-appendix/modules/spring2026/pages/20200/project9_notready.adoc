...
Also, https://httpbin.org[httpbin.org] is a great service for testing HTTP requests which just  echoes back what you send to it, which makes it a nice tool for learning how APIs work.
