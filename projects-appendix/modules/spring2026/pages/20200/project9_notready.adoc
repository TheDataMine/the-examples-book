...
We briefly touched on FastAPI but lets get more into it and expand on our API now we have a baseline. We are going to build a complete CRUD (Create, Read, Update, Delete) API that demonstrates all the main HTTP methods.
