...
To run our FastAPI application, we need a server. FastAPI works with https://asgi.readthedocs.io/en/latest/introduction.html[ASGI servers], and the most common one is `uvicorn`. 
