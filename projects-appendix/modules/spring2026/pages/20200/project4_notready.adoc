...
While matplotlib is great for simiple, static visualizations, it doesn't provide the interactivity we are looking for. We will use plotly to achieve this. 
...
For more information, see: https://ipywidgets.readthedocs.io/en/latest/examples/Widget%20List.html
...
[NOTE]
----
The basic syntax is `px.bar(df, x='category', y='value')`, and you can see more details here: https://plotly.com/python-api-reference/generated/plotly.express.bar
----
...
`dropdown.observe`: This is a function provided through ipywidgets that calls a function specified when there is a change to the dropdown widget. Without this, we wouldn't be able to automatically show the user the updated plot even if a new selection has been made. 

[NOTE]
----
You can read more about the details of using widget events here: https://ipywidgets.readthedocs.io/en/7.x/examples/Widget%20Events.html
----
...
`VBox()` holds label, dropdown, and output, where when displayed, the label appears at the top similar to a title, the dropdown appears below the label with selection options, and the otuput widget is the area where plots and/or messages are outputted to the user. 
...
image::q1.png[q1,400,300, align="center"]
...
- 1c. Code to create interactive widget and medal plot for country selection. Make sure countires are listed in alphabetical order. Show all outputs. 
- 1d. Explain in your own words how Dropdown and VBox works, and how they work in our example. 
- 1e. 

• Explain in your own words the difference between the interactive Plotly + widget visualizaiton and the traditional, static plotting methods we have been using (for instance, through matplotlib). 
• In what situations would we prefer one over the other?
• Explain and give minimum two advantanges and disadvantages of both methods.
====
...
- Creates a plot showing the change in participation over time. x-axis represents the year nad y-axis represents the number of athletes. Add title to the plot. 

Below is an example output of what you can expect to see.

image::q3.png[q3,400,300, align="center"]
...
image::q4.png[q4,400,300, align="center"]
...
You can read a lot more about layouts here: https://ipywidgets.readthedocs.io/en/latest/examples/Widget%20Layout.html
...
image::q5_1.png[q5_1,400,200, align="center"]
...
image::q5_2.png[q5_2, 400, 100, align="center"]
...
image::q5_bar.png[q5_bar, 400, 100, align="center"]

image::q5_line.png[q5_line, 400, 100, align="center"]
