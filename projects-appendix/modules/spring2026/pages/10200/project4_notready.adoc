...
The orignal source for this dataset can be found https://www.kaggle.com/datasets/yasserh/titanic-dataset[here], providing more insight into the description and what others have done with it. 
...
ADD a note about 'watch the video to learn about reading in the dataset'
++++
...
2 - If you do not want to have to download anything, copy and paste the url of the raw format of this dataset into your `pd.read_csv` statement and continue from there.
