...
There are some more default color gradients you can learn about https://python-visualization.github.io/folium/latest/advanced_guide/colormaps.html[here].
