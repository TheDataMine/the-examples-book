...
image:pandas-polars1.jpg[A 2D cartoon illustration of two bears from 'We Bare Bears' sitting inside a brown cardboard box. On the left, Panda is smiling and rubbing his eye with a paw. On the right, Ice Bear looks on with a calm, neutral expression. They are set against a light-tan, wood-paneled wall, width=48%, title="Panda and Ice Bear sitting together in a cardboard box."]
image:pandas-polars2.jpg[A 2D cartoon illustration of the same two bears in the cardboard box. Panda is now leaning toward the right with a soft, curious smile. Ice Bear is looking straight ahead with a grumpy expression, puffing out his cheeks as if annoyed or determined. The background remains the same wood-paneled wall, width=48%, title="Ice Bear reacting with a grumpy, puffed-cheek expression while Panda watches."]
