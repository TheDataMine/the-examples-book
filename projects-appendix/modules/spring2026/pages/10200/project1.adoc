...
If you are a graduate student, then please click into the Piazza link at the level in which you are taking the course.  Please https://the-examples-book.com/setup#get-help[submit a ticket], if you are unsure.
...
image::DatamineServer.png[Server Options for Jupyter Lab, width=792, height=500, loading=lazy, title="Server Options for Jupyter Lab"]
