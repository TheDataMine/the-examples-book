...
.Learning Objectives
****
- Learn how to work with date-time data 
- Practice creating informative plots
...
Earlier in https://the-examples-book.com/projects/spring2026/10200/project4[Project 4], we created a column that contained categorical values in the Titanic dataset. This looked like:
