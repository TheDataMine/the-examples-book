...
image::cat-airplane.gif[Cartoon cat flying an airplane (decorative), width=70%, align=center]
...
Please implement the same for the years to create a new `year` column. From these new columns, check out how the data is distributed in their respective value counts (for each month and year).
...
Way back long ago in https://the-examples-book.com/projects/spring2026/10200/project4[Project 4], we created a column that contained categorical values in the Titanic dataset. This looked like:
