...
=== Question 2 (2 points) 
Read in the Social Media dataset as `myDF` from `/anvil/projects/tdm/data/social_media_addiction/social_media.csv` and show the dimensions and the `head()` of the data. 
