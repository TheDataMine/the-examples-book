...
**Relevant topics:** xref:programming-languages:SQL:index.adoc[SQL], xref:programming-languages:SQL:queries.adoc[queries]
...
**Relevant topics:** xref:programming-languages:SQL:index.adoc[SQL], xref:programming-languages:SQL:queries.adoc[queries], xref:programming-languages:SQL:joins.adoc[joins]
