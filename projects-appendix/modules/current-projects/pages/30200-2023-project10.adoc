...
[source,bash]
----
singulariy exec /anvil/projects/tdm/apps/containers/images/python:f2022-s2023.sif /path/to/bootstrap_samples.py bootstrap 10 --output /anvil/scratch/USERNAME/p10output/
----
