...
. The `.ipynb` file (based off of the provided template). See xref:book:projects-appendix:submissions.adoc#how-to-download-notebook[here] to learn how to download the `.ipynb` file.
+
[IMPORTANT]
====
...
You will be graded on the work and how it is rendered in Gradescope, _not_ how it renders on https://ondemand.anvil.rcac.purdue.edu. Please see xref:book:projects-appendix:submissions.adoc#double-checking-submissions[here] to learn how to properly double check your submission and make sure it renders properly in Gradescope.
====
+
