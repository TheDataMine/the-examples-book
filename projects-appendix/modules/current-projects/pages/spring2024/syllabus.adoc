...
2. *Locate information using effective search strategies and relevant information sources.*  Again, the seminar progresses by increasing the complexity of the problems.  The students are being asked to solve complex problems using data science tools. They need to figure out what they are looking to figure out, and to do that they need to figure out what to ask. We equip them with the tools and initial foundation, and additional resources such as Piazza (discussion platform), office hours, and attending seminar for instructor interaction.
3. *Evaluate the credibility of information.*  Some of the projects students complete in the course involve data cleansing efforts including validation, verification, missing data, and modeling. 
4. *Synthesize and organize information from different sources in order to communicate.*  The students use help from Piazza, office hours, the videos from the instructor and seminar live sessions to synthesize and organize the information they are learning about the related projects in order to get to the correct answers for their projects each week.
5. *Attribute original ideas of others through proper citing, referencing, paraphrasing, summarizing, and quoting.*  This is a required question in the beginning of the project template that students submit every week. 
6. *Recognize relevant cultural and other contextual factors when using information.*  Students weekly project include data and information on gender data and political data.  Students are also required to complete professional development through event attendance including culture in data science and multicultural events.  
7. *Observe ethical and legal guidelines and requirements for the use of published, confidential, and/or proprietary information.*  Students complete an academic integrity quiz at the beginning of each semester.

=== Assessment of Foundational Learning Outcome (FLO) = Information Literacy

1. *Assessment method for this course.*  Students are assigned a weekly project that usually includes a data set and then questions about the data set that engage the student in experiential learning.  Each week, these projects are graded by teaching assistants based on a solutions provided.
...
8. *Observe ethical and legal guidelines and requirements for the use of published, confidential, and/or proprietary information.*  Students complete an academic integrity quiz at the beginning of each semester.
