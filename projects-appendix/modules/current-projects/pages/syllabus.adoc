...
* *T.A.s*: Visit their xref:spring2024/TA/officehours.adoc[office hours] and use the link:https://piazza.com/[Piazza site]
...
The xref:spring2024/TA/officehours.adoc[office hours schedule is posted here.]
...
xref:schedule.adoc[Click here to view the Spring 2024 Course Schedule]
