...
=== Question 1
A) How many cores and how much memory (in GB) do Anvil's sub-clusters A, B, and G have altogether?

B) How many cores and how much memory (in GB) does your personal computer have?
...
=== Question 2
A) What is the name of the node on Anvil that you are running on?
...
=== Question 3
A) Run each of the example code snippets below, and include them and their output in your submission to get credit for this question.
...
=== Question 4
A) Using Python, calculate how many cores and how much memory (in GB) the A, B, and G sub-clusters of Anvil have altogether.

B) Using R, calculate how many cores and how much memory (in GB) the A, B, and G sub-clusters of Anvil have altogether. (Remember to use line magic!)
...
.Items to submit
====
- Code used to solve parts A and B of this problem.
- Output from running the code.
====

=== Question 5
A) Load the "flight_of_passage.csv" data into an R dataframe called "dat".

B) Take the head of "dat" to ensure your data loaded in correctly.

C) Change the name of "dat" to "flight_of_passage", remove the reference to "dat", and then take the head of "dat" and "flight of passage" in order to ensure that your actions were successful.
...
.Items to submit
====
- Code used to solve parts A, B, and C of this problem.
- Output from running the code.
====
