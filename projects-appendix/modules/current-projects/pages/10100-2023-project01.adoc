...
.. Change the name of "dat" to "flight_of_passage", remove the reference to "dat", and then take the head of "flight of passage" in order to ensure that your actions were successful.
