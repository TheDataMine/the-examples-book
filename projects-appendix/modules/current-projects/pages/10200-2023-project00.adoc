...
----
[loweralpha]
.. Create an instance of the class Card and call it `my_card`. Then run these
[source, python]
----
print(my_card)
my_card
...
Its important to point out that a Python function inside a `class` is called a method.
