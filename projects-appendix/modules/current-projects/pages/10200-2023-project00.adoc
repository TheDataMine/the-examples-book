...
=== TWO
Create a new function that accepts a ride name as an argument, and prints the first year the data for that ride was collected and the most recent year that the data for that ride was collected.
