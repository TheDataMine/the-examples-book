...
.. How many duplicate `ProfileName` values are there? (I am not asking for which values are duplicated but just the total number of duplicated `ProfileNames`; it is helpful to explain your answer for this one.) 
