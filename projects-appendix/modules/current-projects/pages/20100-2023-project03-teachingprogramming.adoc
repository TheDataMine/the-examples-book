...
- Example to check number range from 100 to 200: '(1[0-9]{2}|3[0-9]{2}|4[0-9]{2}|200)\b'- \b: Represents a word boundary, ensuring that the number is not part of a larger word or number.
====
