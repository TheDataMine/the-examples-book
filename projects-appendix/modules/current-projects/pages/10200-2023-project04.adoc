...
[WARNING]
====
This is Project FOUR (not THREE), and we have it posted earlier than usual.  This project is not due until Friday, February 10.  If you are just starting the project, you might be looking for Project 3, which is due this Friday, February 3.  Hope that helps!
====
