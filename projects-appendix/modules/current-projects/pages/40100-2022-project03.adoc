...
- Recreate `my.db` with new schema.
- Use python to insert all of your sample data into the database. Verify success by running the following queries.
- Write queries on the link tables, etc.
