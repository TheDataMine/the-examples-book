...
[loweralpha]
.. Create a variable called `mydata` that is a list of 6 tuples, where each tuple has a student's first name, age and major. (You may make up the students' information.)
