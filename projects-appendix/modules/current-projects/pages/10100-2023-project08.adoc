...
Using the code above, to answer these questions.  We want you to use the data frame `my_selection` when solving Question 4.  (Do not use the full `products` data frame for Question 4.)
