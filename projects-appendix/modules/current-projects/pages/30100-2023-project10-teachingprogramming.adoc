...
[NOTE]
====
You may get more information about `xpath` here: https://stackoverflow.com/questions/11657223/xpath-get-following-sibling.
====
 

=== Question 2 (4 pts)

Okay, Now, let us look into a website of the housing market. https://zillow.com has extremely rich data on homes for sale, for rent, and lots of land.
