...
It migth be helpful to get an overview of the structure of the data frame, by using the `str()` function:
...
[loweralpha]
.. Using the two data sets, create two separate graphs or plots on the data that you find interesting (one graph or plot for each of the two data sets in this project).  Write 1-2 sentences on each one and why you found it interesting.  Explain what you noticed in the dataset. 
