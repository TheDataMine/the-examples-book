...
- NOTE: Here `myDF` is variable name which can be anything you want to use to refer to the dataframe. In practice, you should use a name that is decriptive of the what is actually contained in the dataframe.
...
- *NOTE*: There may be some datasets do not follow that convention.
