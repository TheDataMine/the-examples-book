...
[TIP]
====
UPDATE: WE ADDED 2 MORE VIDEOS FOR PROJECT 6, which are given under https://the-examples-book.com/programming-languages/python/writing-functions#new-videos-for-project-6[the heading Project 6 videos in this section].
====
