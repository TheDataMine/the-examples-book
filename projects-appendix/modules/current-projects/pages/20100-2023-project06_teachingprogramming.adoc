...
[loweralpha]
.. Please list the months-and-years and the average `wind_speed_average` for the months-and-years in the file:

`/anvil/projects/tdm/data/whin/observations.csv`

Make sure the output is sorted by the month-and-year (you can use `sort` for that).  An example of month-and-year is 2020-10 for example.
