...
xref:starter-guides:tools-and-standards:unix:standard-utilities:pwd.adoc[pwd], xref:starter-guides:tools-and-standards:unix:standard-utilities:cd.adoc[cd], xref:starter-guides:tools-and-standards:unix:standard-utilities:ls.adoc[ls]
...
**Relevant topics:** xref:starter-guides:tools-and-standards:unix:standard-utilities:pwd.adoc[pwd], xref:starter-guides:tools-and-standards:unix:standard-utilities:cd.adoc[cd], xref:starter-guides:tools-and-standards:unix:other-topics:special-symbols.adoc[. & .. & ~]
...
Sometimes, you may want to know what the first or last few lines of your file look like. xref:starter-guides:tools-and-standards:unix:standard-utilities:head.adoc[head] and xref:starter-guides:tools-and-standards:unix:standard-utilities:tail.adoc[tail] can help us do that. Take a look at their documentation to learn more.

One goal of our programs is often to be size-efficient. If we have a very simple program, but it is enormous, it may not be worth our time to download and use. The xref:starter-guides:tools-and-standards:unix:standard-utilities:wc.adoc[wc] tool can help us determine the size of our file. Take a look at its documentation for more information.
...
Finally, we often may know that a program exists, but we don't know where it is. xref:starter-guides:tools-and-standards:unix:standard-utilities:which.adoc[which] can help us find the location of a program. Take a look at its documentation for more information, and use it to solve the last part of this question.
...
**Relevant topics:** xref:starter-guides:tools-and-standards:unix:standard-utilities:pwd.adoc[pwd], xref:starter-guides:tools-and-standards:unix:standard-utilities:cd.adoc[cd], xref:starter-guides:tools-and-standards:unix:standard-utilities:head.adoc[head], xref:starter-guides:tools-and-standards:unix:standard-utilities:tail.adoc[tail], xref:starter-guides:tools-and-standards:unix:standard-utilities:wc.adoc[wc], xref:starter-guides:tools-and-standards:unix:standard-utilities:which.adoc[which], xref:starter-guides:tools-and-standards:unix:standard-utilities:type.adoc[type]
...
**Relevant topics:** xref:starter-guides:tools-and-standards:unix:standard-utilities:cp.adoc[cp], xref:starter-guides:tools-and-standards:unix:standard-utilities:rm.adoc[rm], xref:starter-guides:tools-and-standards:unix:standard-utilities:touch.adoc[touch], xref:starter-guides:tools-and-standards:unix:standard-utilities:cd.adoc[cd]
