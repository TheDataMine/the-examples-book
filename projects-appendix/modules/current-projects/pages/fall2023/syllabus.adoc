...
* *T.A.s*: Check who your T.A.s are on the xref:fall2023/ta_overview.adoc[T.A. Overview] page. Visit their xref:fall2023/office_hours.adoc[office hours] or use the link:https://piazza.com/[Piazza forum] to get in touch.
