...
|===      
include::projects-appendix:current-projects:example$10100-2022-projects.csv[]                              
|===
...
**Always** double check that the work that you submitted was uploaded properly. See xref:book:projects-appendix:current-projects:submissions.adoc[here] for more information.
