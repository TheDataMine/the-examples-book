...
[loweralpha]
.. How many unique manufacturers are there in the dataset? List 5 different manufacturers included in this dataset.
.. How many cars have driven more than 100,000 miles according to the odometer column?
.. What is the minimum and maximum non-zero price for the cars in the dataset? Which price appears most frequently in the dataset?
