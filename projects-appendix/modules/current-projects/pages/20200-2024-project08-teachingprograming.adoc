...
.. Run a SQL Query on the view to get the maximum wind speed recorded by each station from column 'wind_speed_mph' 

[TIP]
====
- You may refer to "sp.sql()"
- Use "group by station_id" to get all record numbers and maximum wind speed in the dataset
====
