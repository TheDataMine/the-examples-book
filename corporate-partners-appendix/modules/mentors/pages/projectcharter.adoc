...
Click here to download the xref:attachment$project_charter_template.docx[Project Charter Template]. Feel welcome to include your companies branding or public facing links. 
