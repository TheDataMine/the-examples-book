...
You will not have to create your own list, unless you want to have an additional list.
...
Disclaimer: The roster may continue changing until registration closes for the students. 
