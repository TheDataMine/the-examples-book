...
The description outlines the who, what, how and why of your envisionedcproject. Ultimately, it helps The Data Mine students select the Corportate Partners project that is right for them. 
