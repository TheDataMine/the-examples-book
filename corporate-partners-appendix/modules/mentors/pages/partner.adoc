...
We are excited to meet with you every other week for 25 minutes during the summer to plan the specifics of your project(s). Visit the xref:summerchecklist.adoc[Summer Planning] page for a readiness checklist. 
