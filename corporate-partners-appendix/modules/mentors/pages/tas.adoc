...
Also, mentors and TAs will work together to define a consistent sprint schedule. The sprint will consist of three sprint ceremonies: xref:projectmanagement:ceremonies.adoc[sprint planning], xref:projectmanagement:ceremonies.adoc[sprint review], and xref:projectmanagement:ceremonies.adoc[sprint retrospective]. Sample Schedules may look like this:
