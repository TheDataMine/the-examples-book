...
The Data Mine asks that mentors and TAs jointly conduct xref:TAs:trainingModules:ta_training_module5_4_mentor_feedback.adoc[performance reviews] of their teams twice a semester (every eight weeks). These reviews are the best times to provide individual and personalized feedback to each student on your team. 
