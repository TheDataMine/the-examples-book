= Fall 2026 TA Responsibility Overview


See the xref:trainingModules/introduction_trainings.adoc[TA Training] for more details on any responsibilities.
Navigate to xref:fall2026/schedule.adoc[Fall 2026 Schedule] to find deadlines.
...
* Attend and support students at the Fall Mid-Year Presentation.