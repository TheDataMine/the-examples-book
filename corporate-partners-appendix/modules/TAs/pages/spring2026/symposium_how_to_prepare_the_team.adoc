...
* Navigate to xref:students:spring2026/symposium_poster_guidelines.adoc[Spring 2026 Poster Guidelines] for more details on the Poster.
* Navigate to xref:students:spring2026/symposium_video_guidelines.adoc[Spring 2026 Video Guidelines] for more details on the Video.
...
View past presentations (from Spring Symposium) on link:https://datamine.purdue.edu/symposium/[The Data Mine Website] to get ideas.
