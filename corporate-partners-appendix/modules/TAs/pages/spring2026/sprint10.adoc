...
:poster-activity-deck: xref:attachment$facilitation_guide-poster_initiation.docx [Poster Initiation Deck]
...
| <<complete-team-report, ✓ Complete Team Report #{current_sprint}>>
| **{teamreport-due}**
| {gradescope-link}
