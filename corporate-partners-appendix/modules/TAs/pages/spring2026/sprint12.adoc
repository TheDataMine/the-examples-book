...
:teamreport-due: Sun, Mar 29, 2026 @ 11:59 PM ET
...
:emotional-intelligence-deck: xref:attachment$EQ_Facilitation.pptx[Emotional Intelligence Slides]
:emotional-intelligence-facilitation: xref:attachment$Facilitaiton_Guide-EQ_Compass.docx[Emotional Intelligence Facilitaiton Guide]
...
After you have completed grading for Professional Development #{previous-sprint}, use lab to complete the Emotional Intelligence Activity.  Use the {emotional-intelligence-deck} and {emotional-intelligence-facilitation} to guide your discussion.  Note that this activity is meant to happen in place of warm up at the beginning of lab, allowing ample time to complete project work.
...
As you review submissions, be sure to note student's thoughts on generative AI to prepare a discussion on GenAI.
...
Due on **Gradescope by {symposium-draft-due}.**  Please review these materials as your team begins working on symposium materials.
