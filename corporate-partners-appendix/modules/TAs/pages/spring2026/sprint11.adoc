...
:3mt-facilitation: xref:attachment$3mt_facilitation_guide 2.pptx[3 minute thesis facilitation guide]
...
*** **Lab Session #1: _Semester Checkins_: TBD** + 


*** **Lab Session #2: _Conflict Resolution_: TBD** + 
