...
| xref:#3mt-initiation-anchor[✓ Submit 3MT Initiation Draft]
| **{3mt-submission-due}**
| {gradescope-link}
...
After you have completed grading for Professional Development #{previous-sprint}, use lab to complete the Poster Initiation Activity.  Use the {3mt-activity-deck} and {3mt-ta-facilitation} to guide your discussion.
...
**Due: on TA Gradescope by {3mt-submission-due}**
