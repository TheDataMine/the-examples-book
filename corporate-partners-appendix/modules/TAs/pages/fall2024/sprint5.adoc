...
&#10003; The team started the Final Fall Presentation. xref:fall2024/final_presentation.adoc[Final Fall Presentation Details]
...
* Next, complete a sprint retrospective of sprint #4. Followed by a daily stand-up and sprint planning for sprint #5.
