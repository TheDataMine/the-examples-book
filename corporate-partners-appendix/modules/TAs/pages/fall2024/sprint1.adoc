...
&#10003; Please prepare the xref:trainingModules/ta_training_module5_11_survey.adoc[Team Introduction Survey] in Qualtrics before *Lab #1*, by following the linked instructions. You will have to customize this survey. 
