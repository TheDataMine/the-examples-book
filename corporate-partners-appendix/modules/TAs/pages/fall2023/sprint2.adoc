...
* Assist students in setting up https://the-examples-book.com/tools/git/github-anvil[Github on Anvil]
** *ACTION ITEM*: Review https://the-examples-book.com/tools/git/github-anvil[Github on Anvil]
...
// dead-link: xref:attachment$RACI.pptx[RACI Guide Powerpoint]
** Use this PowerPoint to facilitate the discussion: RACI Guide Powerpoint
