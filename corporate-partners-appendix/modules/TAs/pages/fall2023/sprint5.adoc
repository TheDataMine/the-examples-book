...
// dead-link: xref:attachment$Initiative_Follow_Through.pptx[Initiative & Follow Through Powerpoint]
** Use this PowerPoint to facilitate the discussion: Initiative & Follow Through Powerpoint
