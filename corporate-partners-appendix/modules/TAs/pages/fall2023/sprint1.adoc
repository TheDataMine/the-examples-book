...
// dead-link: xref:attachment$Organizational_Behavior.pptx[Organizational Behavior Facilitator Guide]
** Use this powerpoint to facilitate the discussion: Organizational Behavior Facilitator Guide
// dead-link: xref:trainingModules/ta_training_module5_6_survey.adoc[Student Background Experience Assessment]
...
// dead-link: xref:starter-guides:ROOT:index.adoc[Starter Guides]
** Starter Guides
** Background Readings
