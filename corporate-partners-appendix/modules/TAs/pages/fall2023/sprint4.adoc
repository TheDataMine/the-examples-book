...
// dead-link: https://the-examples-book.com/crp/TAs/trainingModules/ta_training_module5_4_mentor_feedback[Mentor and TA Feedback Guide]
&#10003; Set-up a meeting with your mentor to complete mid-semester feedback. Mid-Semester Evals are due October 25. You can begin this assignment during this sprint with your mentor. Please make them aware and share the rubric with them early so they may begin preparing. Mentor and TA Feedback Guide
...
// dead-link: xref:attachment$ProblemSolving_Sp4_2.pptx[Problem Solving and Decision Making]
** Use this PowerPoint to facilitate the discussion: Problem Solving and Decision Making
