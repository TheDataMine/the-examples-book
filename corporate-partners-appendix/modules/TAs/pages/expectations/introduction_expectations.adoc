...
After reviewing expectations, it is recommended to look through the xref:trainingModules/ta_training_resources.adoc[resources] branch as it has many tools developed for TAs. 