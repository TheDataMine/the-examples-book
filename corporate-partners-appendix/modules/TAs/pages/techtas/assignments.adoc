...
// dead-link: https://the-examples-book.com/crp/TAs/trainingModules/ta_training_Q_and_A[this Q&A page]
If you don't have the data yet, please visit the Q&A page for some ideas.
...
We have a https://the-examples-book.com/tools/git/github-anvil[short example how to use GitHub in Anvil], but it'd be helpful to have a tutorial on using Git for version control, which is essential for collaborative data science projects like your CRP project.
