...
&#10003; If your team completed the xref:trainingModules/ta_training_module5_11_survey.adoc[Team Introduction Survey], consider sharing the results with your mentors.
