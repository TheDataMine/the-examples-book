...
&#10003; Facilitate team discussion of RACI Matrix using the RACI Guide PowerPoint??
...
&#10003; If you have new students on the team, help them get up to speed on tasks to do (NDA, background readings, team intricution survey, etc)
