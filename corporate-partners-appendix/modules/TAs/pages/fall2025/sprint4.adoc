...
2. **Reviewing Professional Development Topics** - In Sprint #3, students conducted mock interviews and learned how to efficiently read scientific papers.  Refer to the assignments xref:students:fall2025/sprint3.adoc[here] and facilitate a conversation about their main takeaways or feedback on the assignments.
