...
:student-content-tasks-link: xref:students:fall2025/sprint3.adoc[Sprint {previous-sprint} Resource,window=_blank]
:meeting-agendas-link: xref:meeting_agendas.adoc[Meeting Agendas] 
...
_**Note:** Icebreakers, Reminders, and the Team Activity section may vary each sprint. +  
Team Activities may include required or optional Professional Development (PD) topics, which will be listed below when applicable._
...
*** **Professional Development Discussion (Optional):**  +
 In Sprint #3, students learned about mock interviews, conflict resolution, and documentation. Refer to the {student-content-tasks-link} and facilitate a conversation about their main takeaways, the conflict resolution practice, and any feedback they have on the assignments.
