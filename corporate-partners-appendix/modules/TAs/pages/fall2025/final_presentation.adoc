...
[NOTE]
====
For the student version of this page, see {student-version-link}, which provides detailed instructions, expectations, and submission guidance.
====

== Purpose

The *Final Presentation* marks the culmination of the fall semester and serves as preparation for the *Corporate Partner Symposium* in spring.  
As a TA, your role is to *guide, coach, and coordinate* your team through this process — ensuring professionalism, clarity, and confidence in delivery.

Your goal extends beyond evaluation — you are supporting students in developing confidence, structure, and collaboration skills.

[IMPORTANT]
====
Remind students that all *Final Presentations* are **confidential** and cannot be shared publicly outside of The Data Mine and Corporate Partner teams.
====

== Key Milestones & TA Checklist

Use this checklist to stay on track as your team progresses through the presentation cycle.  

[cols="^1,2,^2,6", options="header"]
|===
| ☑ | **Dates** | **Title** | **TA Action Items**

| [ ] 
| **Oct 29 – Nov 19, 2025** 
| *Presentation Development Phase* 
| - Introduce *Final Presentation* expectations. +
- Confirm attendee list with your mentor *(have a list by Sprint #5).* +
- Remind students that all *Final Presentations* are **confidential**. +
- Show **"World’s Worst Presentation Ever"** +
- Facilitate use of the *Transformation Matrix* and **Data Storytelling** +
- Remind students to use Purdue or Corporate Partner templates. +
- Help assign **section ownership** and set up a **shared PowerPoint** +
- Ensure all students have a defined role. +
- Facilitate a collaborative slide review session.
| [ ] 
| **Nov 19, 2025** 
| *Draft Submission* 
| - Verify the draft is at least **60 % complete** (placeholders + structure). +
- Confirm slide order, section transitions, and time allocation per section. +
- Ensure all students have contributed to their assigned slides. +
- Submit *Fall Presentation Draft Materials* on behalf of the team.

| [ ] 
.2+| **Nov 19 – Dec 5, 2025** 
| *Revision* 
| - Review feedback with your team and refine slides accordingly. +
- Identify backup speakers for each section. +
- Facilitate a collaborative slide review session.
| [ ] 
| *Practice & Feedback* 
| - Facilitate one or more **practice sessions** during lab. +
- Lead a collaborative feedback discussion.
| [ ] 
| **Dec 5, 2025** 
| *Final Submission* 
| - Confirm the deck is fully polished and reviewed. +
- Verify all slides meet formatting standards. +
- Submit *Final Fall Presentation Materials* on behalf of the team.

| [ ] 
| **Dec 8 – Dec 12, 2025** 
| *Presentation Delivery* 
| - Support the team during final delivery in their regular meeting. +
- Congratulate the team and debrief briefly after the presentation.
|===

[TIP]
====
Consider printing or pinning this checklist in your TA folder — it serves as a quick reference during Sprints 5 – 7.
====
////
