...
Refer to {rubric-url} for details on key criteria and performance expectations for your final presentation.
...
Refer to {rubric-url} for details on how the presentation will be evaluated.
