...
In Sprint 5, the team completed the Tuckman’s Model Review. Use this activity to share perspectives, agree on the current stage, and decide on one action step.
