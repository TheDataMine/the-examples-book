...
By the end of this sprint, you will be submitting the draft presentation on behalf of your team. The process began in Sprint 5, and in Sprint 6, you should have completed the activities outlined in the {lab-session} section above. +
