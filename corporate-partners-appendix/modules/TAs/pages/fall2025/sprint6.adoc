...
* As a team decide on the stage (by vote or count) and identify one collective action step, drawing from their Professional Development assignment or new ideas, to help maintain or reach the Performing stage.
* Ask one team member (or post yourself) to share a short summary in the team channel during or after lab.

Due: **Post on Team Channel on the day of the lab.**
