...
This sprint, you will be submitting the draft presentation on behalf of your team. The process began in Sprint 5 with several team activities, and in Sprint 6, you should follow the activities outlined in {lab-session} above. +
