...
:team-stages-discussion: xref:#team-stages[Team Discussion: Tuckman's Model Review]
...
* Share which stage each of you selected and briefly explain your reasoning — do we agree or disagree?
* As a group, decide on the stage (by vote or count) and identify one collective action step, drawing from your Professional Development assignment or new ideas, to help the team maintain or reach the Performing stage.
* One team member (or the TA) posts a short summary in the team channel during or after lab.

Due:  on **Team Channel** during or after lab
