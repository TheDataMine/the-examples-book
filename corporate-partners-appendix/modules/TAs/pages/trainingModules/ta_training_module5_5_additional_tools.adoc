...
// dead-link: https://the-examples-book.com/tools/data-science/intro-to-ds/intro-to-data-science[Introduction to Data Science]
Introduction to Data Science

// Navigate to: link:https://the-examples-book.com/tools/ds-resources/[Supplementary Data Science Reading List]

 Navigate to: https://the-examples-book.com/tools/nlp/prodigy[Prodigy Annotation]

 Navigate to: https://the-examples-book.com/tools/gis/introduction-gis[Geospatial Analytics]

// dead-link: https://the-examples-book.com/tools/data-science/data-visualization/introduction-data-visualization[Data Visualization]
Data Visualization

Navigate to: link:https://the-examples-book.com/tools/matlab/introduction-matlab[MATLAB]

// dead-link: https://the-examples-book.com/tools/data-science/data-analysis/optimization.adoc[Optimization]
Navigate to: Optimization

// dead-link: https://the-examples-book.com/tools/nlp/introduction-nlp[Natural Language Processing]
Navigate to: Natural Language Processing
