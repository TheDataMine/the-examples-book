...
image::5_timesheet.png[Reviewing and Submitting, width=500, height=200, loading=lazy, title="Reviewing and Submitting"]

image::6_timesheet.png[Final Header After Submission, width=500, height=120, loading=lazy, title="Final Header After Submission"]
