...
2. Create a spreadsheet or list and track student attendance each meeting and lab. You can use this attendance tracker template: xref:attachment$TA_Documentation_Template.xlsm[Attendance Tracker]
