...
expected to be present for every meeting of the classes in which they are enrolled. Please see the xref:students:fall2026/syllabus.adoc[syllabus] for a list of excused absences in the Attendance Policy section. 
