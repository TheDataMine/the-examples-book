...
* Use this student attendance template to keep track of lab and meeting attendance : xref:attachment$TA_Documentation_Template.xlsm[Attendance Tracker]
* Trust your judgment, it is ok to say no. Give the students a reason, if applicable.
