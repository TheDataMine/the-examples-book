...
Please refer to xref:expectation/grading.adoc[Grading] for more information on TA expectations for grading.
...
== Labs and Meetings
Please refer to xref:expectations/team_meetings.adoc[Team Meetings] and xref:rhythms_team_labs.adoc[Labs] for more information on TA expectations for team meetings and labs