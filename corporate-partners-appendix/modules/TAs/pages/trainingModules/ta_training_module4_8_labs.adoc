...
Along with  xref:ta_training_module4_7_meetings.adoc[Team Meetings], TAs are responsible for leading weekly lab meetings. These lab sessions are about 2 hours long and is the best time to get work done as a team. This time in lab can be used as best fit, but here are a few suggestions.
...
Find examples of successful icebreakers by navigating to xref:ta_training_module3_4_warmups.adoc[warm-ups]. 

[TIP]
====
Review team building information at xref:ta_training_module3_3_environment.adoc[Creating a Welcoming Environment]
====
