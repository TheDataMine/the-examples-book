= TA Training Module 6: Expectations

Please read through the xref:expectations/introduction_expectations.adoc[Expecations] of being a TA. This includes communication, documentation, planning and meetings, grading, and student check-ins. You will need to know the information in this section. You are welcome and encouraged to refer to it at anytime and share it with other TAs.  
