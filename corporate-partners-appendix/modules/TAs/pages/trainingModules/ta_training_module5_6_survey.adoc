...
5. Create a new survey with your choice of name. Copy a survey from an existing project. Select the survey shared with you titled "The Data Mine Corporate Partners Introduction Survey"
