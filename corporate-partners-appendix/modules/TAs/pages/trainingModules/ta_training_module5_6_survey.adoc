= Corporate Partners Project Introduction Survey
...
5. Create a new survey with your choice of name. Download the survey QSF file from this xref:attachment$The_Data_Mine_Corporate_Partners_Introduction_Survey.qsf[link]. Import a survey from a QSF file and choose the file you just downloaded. Select Create Project.
