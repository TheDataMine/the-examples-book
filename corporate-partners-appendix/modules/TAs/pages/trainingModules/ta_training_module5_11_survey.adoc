...
5. Create a new survey with your choice of name. Download the survey QSF file from this xref:attachment$CRP_Team_Introduction_Survey.qsf[link]. Import a survey from a QSF file and choose the file you just downloaded. Select Create Project.
