...
&#10003; Prepare an icebreaker for the first lab. Navigate to xref:ta_training_module3_4_warmups.adoc[TA Created Warm-Ups] to choose icebreakers, create, or find more.

&#10003; Plan my first lab! I remembered an introduction, agile explanation, and reminders about the syllabus/quizzes and NDAs (if your company has provided them already). Navigate to the xref:ta_training_module4_8_labs.adoc[Lab Planning Guide] for an outline of how to create a lab.  
