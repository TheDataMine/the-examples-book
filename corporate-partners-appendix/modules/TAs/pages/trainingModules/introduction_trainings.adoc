...
&#10003; Prepare an icebreaker for the first lab. Navigate to xref:trainingModules/ta_training_module4_3_warmups.adoc[TA Created Warm-Ups] to choose icebreakers, create, or find more. Most of your first lab will be completing the xref:./agile/agile-lego-activity.adoc[Lego Agile Activity].
