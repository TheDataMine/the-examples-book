...
&#10003; Complete Training Modules 0-6 found under xref:trainingModules/introduction_trainings.adoc[TA Training].
...
== Fall Preparation
These are steps you should take as a TA to prepare for the Fall semester in addition to the required trainings.

&#10003; Set up an link:https://the-examples-book.com/tools/anvil/access-setup[ACCESS account]

&#10003; Meet with my Corporate Mentor to discuss project expectations and communication methods. 

&#10003; Double checked I have access to my MS Teams Group. Reviewed xref:students:fall2026/MS_Teams.adoc[Microsoft Teams Email Groups]
...
&#10003; Check the xref:fall2026/schedule.adoc[TA schedule] to identify due dates for the semester and required TA meetings.
