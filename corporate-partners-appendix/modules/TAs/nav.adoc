...
**** xref:trainingModules/ta_training_module3_1_diversity.adoc[3.1: Student Perspectives Training]
**** xref:trainingModules/ta_training_module3_2_inclusion.adoc[3.2: Student Experiences Training]
