...
** Fall 2024
*** xref:fall2024/schedule.adoc[Spring Schedule]
...
*** Symposium
**** xref:fall2024/symposium_how_to_prepare_the_team.adoc[Preparing the Team]
**** xref:fall2024/symposium_ta_expectations.adoc[TA Expectations]
**** xref:fall2024/symposium_youtube.adoc[Video Submission Instructions]
