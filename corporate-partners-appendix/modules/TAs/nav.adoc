...
*** xref:trainingModules/ta_training_module3.adoc[Module 3: Valuing Student Perspectives and Experiences in Data Science Training]
**** xref:trainingModules/ta_training_module3_1_diversity.adoc[3.1: Part One - Valuing Student Perspectives and Experiences in Data Science Training]
**** xref:trainingModules/ta_training_module3_2_inclusion.adoc[3.2: Part Two - Valuing Student Perspectives and Experiences in Data Science Training]
