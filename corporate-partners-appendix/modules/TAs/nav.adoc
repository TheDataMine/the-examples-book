...
**** xref:trainingModules/ta_training_module4_2_environment.adoc[4.2: Building Welconing Teams]
***** xref:trainingModules/ta_training_module4_6_1_v_environment.adoc[4.2a: Promoting a Strong Virtual Team Environemnt]
