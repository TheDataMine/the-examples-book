...
**** xref:trainingModules/ta_training_module4_2_environment.adoc[4.2: Creating a More Welcoming Virtual Environment]
**** xref:trainingModules/ta_training_module4_3_warmups.adoc[4.3: Warm-Ups/Icebreaker ]
