...
*** xref:ndmntas/attendance_policy.adoc[NDMN Student Attendance Policy]
*** xref:ndmntas/responsibility_overview.adoc[NDMN TA Responsibility Overview]
*** xref:ndmntas/softer_attnd.adoc[NDMN Softer Student Attendance Policy]
...
**** xref:trainingModules/ta_training_module4_2_environment.adoc[4.2: Team Building in the Virtual World]
**** xref:trainingModules/ta_training_module4_3_warmups.adoc[4.3: Warm-Ups/Icebreaker Activities]
...
**** xref:trainingModules/ta_training_module4_6_virtual.adoc[4.6: Virtual Resources]
***** xref:trainingModules/ta_training_module4_6_1_v_environment.adoc[Creating a welcoming virtual environment]
***** xref:trainingModules/ta_training_module4_6_2_icebreakers.adoc[Icebreaker Activities]
***** xref:trainingModules/ta_training_module4_6_3_15checks.adoc[15 Minute Check Ins]
***** xref:trainingModules/ta_training_module4_6_4_zoom.adoc[Zoom Guide/Netiquette]
***** xref:trainingModules/ta_training_module4_6_5_advice.adoc[Words of Advice]
**** xref:trainingModules/ta_training_module4_7_check_ins.adoc[4.7: Check Ins]
...
*** xref:trainingModules/ta_training_module7.adoc[Module 7: Microsoft Teams Training]
**** xref:trainingModules/ta_training_module7_1_introduction.adoc[Introduction]
**** xref:trainingModules/ta_training_module7_2_agile_overview.adoc[Agile Methodology Overview]
**** xref:trainingModules/ta_training_module7_3_teams_basics.adoc[Microsoft Teams Basics]
**** xref:trainingModules/ta_training_module7_4_setting_up_teams.adoc[Setting Up Microsoft Teams for Agile Projects]
**** xref:trainingModules/ta_training_module7_5_roles_responsibilities.adoc[Roles and Responsibilities]
**** xref:trainingModules/ta_training_module7_6_managing_sprints.adoc[Managing Sprints in Microsoft Teams]
**** xref:trainingModules/ta_training_module7_7_communication.adoc[Effective Communication in Teams]
**** xref:trainingModules/ta_training_module7_8_best_practices.adoc[Best Practices]
**** xref:trainingModules/ta_training_module7_9_troubleshooting.adoc[Troubleshooting and Support]
