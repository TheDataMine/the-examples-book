...
** Spring 2026
*** xref:spring2026/schedule.adoc[Spring Schedule]
*** xref:spring2026/pta_liaison_assignment.adoc[PTA and Liaison Assignment]
*** xref:spring2026/responsibilities.adoc[Responsibility Overview]
...
*** Symposium
**** xref:spring2026/symposium_how_to_prepare_the_team.adoc[Preparing the Team]
**** xref:spring2026/symposium_ta_expectations.adoc[TA Expectations]
**** xref:spring2026/symposium_youtube.adoc[Video Submission Instructions]
**** xref:spring2026/symposium_poster_print.adoc[Poster Printing Instructions]
...
**** xref:trainingModules/ta_training_module5_12_attendance_tracker.adoc[5.5.1: Attendance Tracker]
...
*** xref:trainingModules/ta_training_assessment.adoc[Module 6: Assessment]
...
*** xref:mid_semester_feedback.adoc[Mentor and TA Feedback Instructions]
...
*** xref:activity_emotional_intelligence.adoc[Emotional Intelligence Compass Activity]
*** xref:activity_poster_initiation.adoc[Poster Initiation Activity]
*** xref:activity_3MT_initiation.adoc[3MT Initiation Activity]
*** xref:symposium_activity.adoc[Symposium Presentation Activities]
...
***** xref:fall2025/final_presentation.adoc[Mid-Year Presentation]
...
//**** xref:trainingModules/ta_training_module5_11_survey.adoc[5.6: Team Intro Survey]
