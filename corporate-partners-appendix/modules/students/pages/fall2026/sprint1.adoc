...
*Where:* Complete the knowledge check for this professional development training on {gradescope-link} in the assignment "Sprint 1: Professional Development".
...
*Where:* {gradescope-link} in the assignment "Sprint 1: Report".
