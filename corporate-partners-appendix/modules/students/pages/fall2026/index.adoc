...
2. Review the xref:syllabus.adoc[fall 2026 syllabus].

3. Review the xref:schedule.adoc[fall 2026 course schedule] for due dates and important dates.

4. Confirm your xref:locations.adoc[meeting time and location]. _This should match the time listed on your official Purdue schedule._ The MS Teams meeting link for your SYNC ONLINE class will be sent a few days before your first day of class. If you do not have this meeting link, please email us at datamine-help@purdue.edu and specify what team you are on.

5. Click on xref:sprint0.adoc[Sprint #0] to review the content for the first week.
