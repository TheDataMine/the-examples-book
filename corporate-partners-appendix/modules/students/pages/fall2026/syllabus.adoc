...
== Course Site
All course material will be posted here in the xref:index.adoc[Corporate Partners section of The Examples Book]. 
...
Due dates are listed in the xref:schedule.adoc[Fall 2026 Student Course Schedule]
...
Use this table to send your questions to the most appropriate email. If you're not sure who to ask, navigate to the xref:questions.adoc[Questions] page for more details.
...
=== Late Policy 
We do NOT accept late work, unless there are extenuating circumstances (link:#_excused_absences[usually in coordination with ODOS]).  
...
*Due dates are listed in the xref:schedule.adoc[semester schedule] with assignments to be completed on link:https://www.gradescope.com/[Gradescope].*

You will need to complete the tasks detailed on each sprint page. The first sprint is covered here:  xref:sprint0.adoc[Sprint 0]. Additional tasks specific to your project will be discussed with your CRP Mentor, TA, and team. 
...
|xref:sprint0.adoc[Sprint 0]
^| 5%
|

|xref:sprint1.adoc[Sprint 1]
^| 10%
|

|xref:sprint2.adoc[Sprint 2]
^| 10%
|

|xref:sprint3.adoc[Sprint 3]
^| 10%
|

|xref:sprint4.adoc[Sprint 4]
^| 10%
|

|xref:sprint5.adoc[Sprint 5]
^| 10%
|

|xref:sprint6.adoc[Sprint 6]
^| 10%
|

|xref:sprint7.adoc[Sprint 7]
^| 10%
|
...
2+|xref:final_presentation.adoc[*Mid-Year Presentation*]
>|10%
