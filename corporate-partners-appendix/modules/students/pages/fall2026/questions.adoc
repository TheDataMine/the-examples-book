...
- xref:schedule.adoc[Course schedule with due dates]
- xref:index.adoc[Where do I start?]
...
Find your Corporate Partner TAs and their email in this table in the xref:syllabus.adoc#corporate-partner-tas[syllabus under the TA section]. 
...
** The xref:syllabus.adoc[Fall 2026 syllabus is here]. 
...
** The meeting locations are listed on your course registration. You will receive a calendar invite for the synchronous online meeting before the first day of class. See the xref:locations.adoc[Locations page] for more details including a map. 
...
** A list of Corporate Partner TAs and emails for Fall 2026 are xref:syllabus#corporate-partner-tas[available in the syllabus here]. 
