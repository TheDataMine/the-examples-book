...
- xref:fall2026/syllabus.adoc[Syllabus]
- xref:fall2026/schedule.adoc[Course schedule with due dates]
- xref:fall2026/index.adoc[Where do I start?]
...
Find your Corporate Partner TAs and their email in this table in the xref:fall2026/syllabus.adoc#corporate-partner-tas[syllabus under the TA section]. 
...
== Seminar Help (1 credit)

* Check out the link:https://the-examples-book.com/projects/fall2026/syllabus[course page and syllabus for Seminar]
* xref: link:https://the-examples-book.com/projects/fall2026/office_hours[TA office hours]
...
** The xref:fall2026/syllabus.adoc[Fall 2026 syllabus is here]. 

* How do I get started on my Corporate Partners project? 
** Start with reviewing xref:sprint0.adoc[Sprint 0 page] for Fall 2026. 

* Where do I go for class?
** The meeting locations are listed on your course registration. You will receive a calendar invite for the synchronous online meeting before the first day of class. See the xref:fall2026/locations.adoc[Locations page] for more details including a map. 
...
** Everything you need to submit is listed in the xref:schedule.adoc[Course Schedule]. Check out the corresponding sprint pages for details. 
...
** A list of Corporate Partner TAs and emails for Fall 2026 are xref:fall2026/syllabus#corporate-partner-tas[available in the syllabus here]. 
