...
Purdue University and The Data Mine are committed to maintaining a community that recognizes and values the inherent worth and dignity of every person; fosters tolerance, sensitivity, understanding, and mutual respect among its members; and encourages each individual to strive to reach their potential. For details, see Purdue’s  link:https://www.purdue.edu/purdue/ea_eou_statement.php[nondiscrimination policy.]
