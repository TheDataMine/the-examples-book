...
|*Spring 2026 Research (what and how)* [20%]
...
|Team presents a thoughtful and mostly complete plan for future work, showing alignment with project goals.
...
|Team acknowledges most contributors and support, though some may be missing or underemphasized.
...
|Team engages actively and provides well-supported answers that demonstrate deep understanding and preparation.
...
|Speakers are confident and knowledgeable, able to explain their work and respond to most questions.
...
|*Overall* [10%]
|Presentation is disorganized and lacks a clear message or direction.
|Presentation is generally clear and professional, though some areas need improvement.
|Presentation is well-structured, informative, and demonstrates solid preparation and teamwork.
|Presentation is exceptional; engaging and professional with strong contributions from all team members and clear vision for future work.
