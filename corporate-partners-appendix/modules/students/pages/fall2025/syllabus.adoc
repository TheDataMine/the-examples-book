...
== Course Description
Students in The Data Mine Corporate Partners Learning Community develop both technical expertise and professional skills through a combination of project-based learning and structured professional development. The course emphasizes communication, teamwork, and leadership—key abilities for success in data-driven careers.

Through *project-based learning*, students collaborate in interdisciplinary teams on real-world, industry-sponsored data projects that address authentic business challenges and generate measurable impact. Teams operate using an adapted Agile methodology, applying principles such as iterative development, sprint planning, and regular retrospectives to manage progress and ensure effective collaboration with Corporate Partner Mentors.

Through *structured professional development*, students strengthen their professional presence, communication, and collaboration skills while preparing for success in future internships and full-time roles.

The goal of the course is to provide a comprehensive, hands-on experience that integrates industry-focused data science projects with career-readiness training. Students gain technical proficiency in data science, visualization, and data engineering, and develop as adaptable, collaborative professionals, supported by The Data Mine staff and data scientists.
...
To be enrolled concurrently in TDM 10100 (I), 20100 (II), 30100 (III), or 40100 (V or VII) (1 credit seminar).
...
This course operates differently from standard academic classes. Students work closely with corporate partners on interdisciplinary, data-driven projects, developing the knowledge and skills through an adapted Agile methodology in a professional, collaborative setting.

Below is an overview of the expected weekly time commitments for each component of the course.
