...
[TIP]
.Template for Project Closure Document
====
xref:attachment$TDM Project Closure.dotx[Download Template]  +
Teams should use this template to complete this document, as it follows the structure outlined on this page. A complete response often requires at least three sentences per section.
====
