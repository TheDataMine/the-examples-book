...
=== DMR, NDMN and IDM 
SYNC ONLINE - Data Mine of the Rockies (DMR), National Data Mine Network (NDMN) and Indiana Data Mine (IDM) students not at Purdue West Lafayette or Indianapolis will join the team meeting remotely.
