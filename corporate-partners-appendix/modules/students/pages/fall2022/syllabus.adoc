...
== Course Site
All course material will be posted here in the xref:fall2022/index.adoc[Corporate Partners section of The Examples Book]. 
...
*	Access to link:https://the-examples-book.com/tools/anvil/access-setup[Setup Anvil]
...
* xref:fall2022/syllabus_purdue_policies.adoc#Inclusion Statement[Inclusion Statement]
...
* xref:fall2022/syllabus_purdue_policies.adoc#Illness and other student emergencies[Absences, Illness, and other student emergencies]
