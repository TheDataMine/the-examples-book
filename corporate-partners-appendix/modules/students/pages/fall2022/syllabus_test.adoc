...
*	Microsoft Word and PowerPoint (remember that link:https://www.itap.purdue.edu/services/microsoft-office-365.html[Microsoft Office is free for all students])
    ** MS Teams installed and logged into your Purdue account  
    ** You will be invited to join your Corporate Partner Team
*	link:https://purdue.brightspace.com/d2l/login[Brightspace] and Gradescope course pages
*	Access to Anvil using Purdue Boilerkey 
...
It is very important to check the Brightspace, Gradescope, and The Examples Book pages frequently! Please review the schedule. More details for each assignment will be available in The Examples Book. *Due dates are listed above in the xref:fall2022/schedule.adoc[semester schedule]*
