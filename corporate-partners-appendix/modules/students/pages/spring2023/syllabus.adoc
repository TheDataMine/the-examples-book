...
== Course Site
All course material will be posted here in the xref:spring2023/index.adoc[Corporate Partners section of The Examples Book]. 
...
*	Access to link:link:https://the-examples-book.com/tools/anvil/access-setup[Setup Anvil]
...
>|50%
3+|Six 2-week sprint reports each worth 10% of your grade. Your single lowest sprint grade will be dropped. You will turn in reports at the end of each sprint to summarize your work competed during the 2-week sprint. 

2+|*Final Report*
>|10%
3+|In lieu of sprint report #7, you will submit an end of the academic year report to summarize your experience and provide feedback. Submitted on Qualtrics. This is not a sprint report so it cannot be dropped. 
...
|Final Poster, Final Video & Presentation at Symposium on April 24, 2023
^| 17%
|
...
// dead-link: xref:professional_development.adoc[Professional Development]
...
* xref:spring2023/syllabus_purdue_policies.adoc#Inclusion Statement[Inclusion Statement]
