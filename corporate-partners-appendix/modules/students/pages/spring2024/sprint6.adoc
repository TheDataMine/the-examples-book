...
<br>
	...
	<div>
		<p><b>What: </b>What is your symposium pitch? Upload a video on Gradescope for your TA to review and give feedback.<a href="https://the-examples-book.com/crp/students/technical_specification_documentation">Review Guidelines for Symposium Pitch</a></p>
<br>
	</div>
	<div>
...
<br>
	...
	<div>
		<p><b>Why: </b>In preparation for The Data Mine symposium, we want student to prepare their symposium pitch for guest at symposium. This assignment will allow your TA to feedback on your pitch.</p>
<br>
  </div>
</div>
