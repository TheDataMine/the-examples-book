...
<div class="panel">
	...
	<div>
		<p><b>What: </b>Review <a href="https://the-examples-book.com/crp/students/agile-training">Agile in The Data Mine Training</a> , participant in the Lego lab activity, and take the quiz.</b></p>
	</div>
	<div>
