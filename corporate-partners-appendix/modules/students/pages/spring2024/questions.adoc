...
// dead-link: https://the-examples-book.com/projects/spring2024/syllabus[course page and syllabus for Seminar]
* Check out the course page and syllabus for Seminar
// dead-link: https://the-examples-book.com/projects/spring2024/office_hours[TA office hours]
* TA office hours
...
** Navigate to the xref:spring2024/ms_team.adoc[MS Teams] page to learn how to login and view past emails in your MS Team email group.
