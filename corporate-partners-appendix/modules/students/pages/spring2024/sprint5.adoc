...
<br>
	...
	<div>
		<p><b>What: </b><a href="https://the-examples-book.com/crp/students/technical_specification_documentation">Review technical specification guide for your team</a> and upload individual reflection on Gradescope.</b></p>
<br>
	</div>
	<div>
