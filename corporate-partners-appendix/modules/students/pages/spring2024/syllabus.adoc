...
== Course Site
All course material will be posted here in the xref:spring2024/index.adoc[Corporate Partners section of The Examples Book]. 
...
Use this table to send your questions to the most appropriate email. If you're not sure who to ask, navigate to the link:https://the-examples-book.com/crp/students/spring2024/questions[Questions] page for more details. 
...
* xref:spring2024/syllabus_purdue_policies.adoc#Inclusion Statement[Inclusion Statement]
