...
// dead-link: https://the-examples-book.com/projects/fall2023/syllabus[course page and syllabus for Seminar]
* Check out the course page and syllabus for Seminar
// dead-link: https://the-examples-book.com/projects/fall2023/office_hours[TA office hours]
* TA office hours
...
// dead-link: xref:./fall2023/ms_team.adoc[MS Teams]
