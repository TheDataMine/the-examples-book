...
Review xref:reading_scientific_papers.adoc[How to read Scientific Paper] for assignment details.
...
<div class="panel">
	...
	<div>
		<p><b>Where: </b>Write a elevator and upload to <a href="https://www.gradescope.com/">Gradescope</a></p>
  </div>
</div>
