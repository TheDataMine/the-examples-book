...
*When:* First Draft due Sunday, November 12, 2023 at 11:59 PM ET. Late work will not be accepted. Final Draft due Sunday, December 3, 2023 at 11:59 PM ET. Late work will not be accepted. *You're TA will submit on behalf of the whole team*
...
<div class="panel">
	...
	<div>
		<p><b>What: </b>Navigate to <a href="https://chat.openai.com/">ChatGPT</a> and give ChatGPT the following prompts: (1) Explain Data Science Ethics to me. (2) When is it appropriate to use ChatGPT for research projects and when is it not appropriate? (3) Create a prompt of your choosing. Complete a short assessment of your learnings on Gradescope</p>
	</div>
	<div>
