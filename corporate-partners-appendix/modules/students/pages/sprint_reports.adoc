...
*There are two or three questions in this section, depending on whether the Implementation Check is included. Answer one of two or two of three questions to receive full credit.*
