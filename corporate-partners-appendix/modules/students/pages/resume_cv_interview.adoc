= Resume/CV or Complete Mock Interview Assignment
...
2. Use the tips you learned to make improvements to your resume or CV. Include your experience in The Data Mine https://the-examples-book.com/crp/students/datamine_resume_LinkedIn[using these guidelines]. 
