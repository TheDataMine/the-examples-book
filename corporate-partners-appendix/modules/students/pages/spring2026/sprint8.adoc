...
== Sprint Tasks
_NOTE: The first sprint has a lot of tasks to help aide with onboarding. In future sprints, plan to spend more time working on your project._

[[onboarding]]
=== &#10003; New Students Onboarding
In the Corporate Partners course, we do not hold a single first class with all 800+ students, as teams begin meeting immediately. Instead, onboarding is completed asynchronously through required setup tasks and a short recorded video that covers first-day information. This includes setting up Anvil (when required) and MS Teams, which are essential tools for project work and communication. This {first-class} video is from fall 2025, but all information is still relevant.
...
*What:* This quiz is optional, as most students completed it in Fall {fall-year}. It is available for new students to take and is worth zero points.
