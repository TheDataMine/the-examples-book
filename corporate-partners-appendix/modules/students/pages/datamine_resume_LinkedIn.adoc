...
IMPORTANT: `The Data Mine, Purdue University` should be listed NOT your company.

Make sure to verify with your mentor what you can share publicly about your project. Anything found in your https://crp.the-examples-book.com/[project description] is typically allowed.
