...
== Settng Up and Connecting Your Account With Microsoft Authenticator
...
image::Authntication_MS_Teams_QR_Code.png[MS Authenthenticator Example QR Code, width=450, height=360, loading=lazy, title="MS Authenthenticator Example QR Code"]
...
(please look at the ticket checklist: link: https://the-examples-book.com/crp/students/ds_team_support#ds-ticket-question-checklist)
