...
Use this table to send your questions to the most appropriate email. If you're not sure who to ask, navigate to the xref:fall2024/questions.adoc[Questions] page for more details.
...
*	link:https://www.rcac.purdue.edu/anvil[Anvil] account  link:https://the-examples-book.com/tools/anvil/access-setup[(Setup Access on Anvil here)]
...
* xref:fall2024/syllabus_purdue_policies.adoc#Inclusion Statement[Inclusion Statement]
