...
// dead-link: https://the-examples-book.com/projects/fall2024/syllabus[course page and syllabus for Seminar]
* Check out the course page and syllabus for Seminar
// dead-link: https://the-examples-book.com/projects/fall2024/office_hours[TA office hours]
* TA office hours
