...
NOTE: The first sprint has a lot of tasks to help aide with onboarding. To account for this extra time, more of your first sprint grade is allocated twords professional development. In future sprints plan to spend more time working on your project.
