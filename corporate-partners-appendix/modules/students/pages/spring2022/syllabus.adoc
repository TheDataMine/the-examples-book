...
Jarai Carter, Limited Term Lecturer, carte403@purdue.edu
...
xref:spring2022/schedule.adoc[Click here to view the Spring 2022 Course Schedule page]
...
It is very important to check this page frequently! *Due dates are listed in the xref:spring2022/schedule.adoc[spring 2022 Course Schedule page].*
