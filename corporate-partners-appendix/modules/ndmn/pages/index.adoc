...
<div class="panel">
  <ul>
    ...
    <li>For Example: Level 1 - (TDM 101/102):</li>
        <ul>
            <li>The Fall Semester focuses on <a href="https://the-examples-book.com/tools/r/" target="_blank">R</a>.</li>
            <li>The Fall Semester focuses on <a href="https://the-examples-book.com/tools/python/python-starter-skills-roadmap" target="_blank">Python</a>.</li>
...
<li>Students in the Corporate Partners Program will:</li>
    <ul>
        ...
        <a href="https://the-examples-book.com/tools/" target="_blank">data science</a>, 
        <a href="https://the-examples-book.com/tools/" target="_blank">data modeling</a>, data visualization, 
        <a href="https://the-examples-book.com/tools/data-analysis-introduction-data-analysis-techniques" target="_blank">data analysis</a>, and data engineering.</li>
...
<div class="panel">
  <ul>
    ...
    <a href="https://the-examples-book.com/crp/students/ds_team_support" target="_blank">support</a>, training, <a href="https://the-examples-book.com/tools/" target="_blank">materials/tools</a>
...
<div class="panel">
  <ul>
    ...
    <li>A list of many MSIs is given here: <!-- dead-link: https://www2.ed.gov/about/offices/list/ocr/edlite-minorityinst.html -->Minority Institutions List (but please inquire if there is any doubt about such classifications or eligibility)</li>
  </ul>
</div>
++++
...
<div class="panel">
  <ul>
    ...
    <li>Participating students will have access to a <a href="https://the-examples-book.com/tools/" target="_blank">rich collection of resources</a> and faculty development opportunities</li>
  </ul>
</div>
++++
...
Check out our xref:universitypartners:workshop_outline.adoc[Spring 2023 Workshops] to help identify the steps needed to bring The Data Mine model to life at your university. 
