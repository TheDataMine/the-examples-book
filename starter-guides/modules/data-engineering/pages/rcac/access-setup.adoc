...
** Follow the instructions here: xref:rcac/purdue-user-setup.adoc[Purdue University (West Lafayette) setup]
. If you are at another university
** Follow the instructions here: xref:rcac/general-user-setup.adoc[General User setup]
