...
In general, anyone working with computers should have a decent if not prolific understanding of a https://www.the-examples-book.com/starter-guides/modules/tools-and-standards/pages/unix/shells.adoc[ shell the most common and well known is Bash]. 
