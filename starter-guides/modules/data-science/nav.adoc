...
*** xref:data-modeling/sampling-methods/introduction.adoc[Sampling Methods]
**** Cross Validation
***** xref:data-modeling/sampling-methods/cross-validation/train-valid-test.adoc[Train, Valid and Test Splits]
***** xref:data-modeling/sampling-methods/cross-validation/loocv-kfold.adoc[Leave-One-Out CV & k-Fold CV]
**** xref:data-modeling/sampling-methods/bootstrap.adoc[Bootstrapping]
**** xref:data-modeling/sampling-methods/markov-chain-monte-carlo.adoc[Markov Chain Monte Carlo (MCMC)]

*** Modeling Process
**** Choosing A Model
***** xref:data-modeling/choosing-model/introduction.adoc[Introduction]
***** xref:data-modeling/choosing-model/accuracy-interpret.adoc[Accuracy vs. Interpretability]
...
***** xref:data-modeling/choosing-model/to-param-or-not-param.adoc[Parameter vs. Non-Parameter Methods]
...
***** xref:data-modeling/process/output.adoc[Thinking About The Output]
...
***** xref:data-modeling/process/model-fit.adoc[Measuring Model Fit]
