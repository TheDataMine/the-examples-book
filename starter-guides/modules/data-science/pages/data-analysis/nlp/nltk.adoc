...
NLTK is a free library that helps do basic as well as incredibly complex task in NLP. From tokenizing, to integrating large corpora, to displaying parsing trees, there is a wide variety of tools in this toolbox and hence its popularity.
