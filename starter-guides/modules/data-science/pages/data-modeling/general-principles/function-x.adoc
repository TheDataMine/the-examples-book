...
Here we explore the meaning of a function, $ f(x) $ in the context of data science. We will look at the basic equation $Y=f(X)$, how this equation can point us towards our general goal in data science, why reducing error is important, and how to estimate $f$.

== The Familiar Function: $Y = f(X) + \epsilon $
