...
* xref:corporate-partners-appendix:students:introduction.adoc[Corporate Partners Student Resources]
...
* xref:data-engineering:intro-to-data-engineering:introduction.adoc[Data Engineering]
...
The data will be stored in project specific locations on Anvil. If you aren't sure of your team's location, please check with the TA. If they aren't sure, you can contact xref:corporate-partners-appendix:students:ds_team_support.adoc[the data science team.]

I tried to install a package, but I'm still getting an error. What's up?::
By design The Data Mine doesn't allow for students to install their own packages. If you need a package installed for your project please contact xref:corporate-partners-appendix:students:ds_team_support.adoc[the data science team.]
...
* Contact xref:corporate-partners-appendix:students:ds_team_support.adoc[the data science team.]

I'm getting an error with my code. Who can help me troubleshoot?::
Check with your TA and team members for help first. If you're still having issues contact xref:corporate-partners-appendix:students:ds_team_support.adoc[the data science team.]
