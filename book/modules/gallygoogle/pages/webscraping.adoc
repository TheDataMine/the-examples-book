...
Note that the line in the script
----
my_elements  = driver.find_elements_by_xpath("//a[@class'bookTitle']/span")
----
lets you scrape for all the information that has the same elements.

This is a great opportunity to play around and take time to try and find other elements.
