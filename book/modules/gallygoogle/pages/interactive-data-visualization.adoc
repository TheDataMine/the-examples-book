...
image::bubblemap.png[width=792, height=500, loading=lazy, title="An outline of the continent of Australia with blue circles that vary in opacity. The darker the circle the more accessible parking, the location of the circle is the actual location of the toilet"]
