...
image::scatterplot.png[Title, width=792, height=500, loading=lazy, Figure 2. An image of a typical scatterplot. The x-axis is the state, the y-axis is if it has accessible toilets]
...
image::bubblechart.png[Title, width=792, height=500, loading=lazy, Figure 3. An image of a scatterplot graph with colored dots representing information. The color is the state, the size is the number of accessible showers, the x-axis is if it is accessible and the y-axis is acessible parking]
