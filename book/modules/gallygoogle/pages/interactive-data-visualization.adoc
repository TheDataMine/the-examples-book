...
image::scatterplot.png[width=792, height=500, loading=lazy, An image of a typical scatterplot. The x-axis is the state, the y-axis is if it has accessible toilets]
