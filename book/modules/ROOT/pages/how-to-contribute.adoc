...
[IMPORTANT]
====
We made an example module to help with any new content. It will be under `template-module` in the repo and the example content page can be found xref:template-module:ROOT:introduction.adoc[here.] Feel free to make a copy and use it for your own module!
====
