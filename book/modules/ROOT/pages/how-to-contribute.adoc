...
If you are interested in making a contribution to this book, the first step is to xref:data-science:git:github-desktop.adoc#install-github-desktop[install and configure GitHub Desktop]. Then, use the quick-start links provided below.
...
. You've xref:data-science:git:github-desktop.adoc#install-github-desktop[installed and configured GitHub Desktop], and your **Current Repository** (in the upper left-hand corner) is set to the-examples-book. Your screen should look similar to the following.
