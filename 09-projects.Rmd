...
**Hint:** [This](https://medium.com/python-features/magic-methods-demystified-3c9e93144bf7) article has examples of both `__str__` and `__repr__`.
...
**Hint:** [This](https://www.tutorialspoint.com/How-to-implement-Python-lt-gt-custom-overloaded-operators) example shows a short example of how to implement these dunder methods.
...
**Hint:** [This](https://medium.com/python-features/magic-methods-demystified-3c9e93144bf7) article has examples of both `__len__` and `__getitem__`.
...
**Relevant topics:** [setitem example](https://www.geeksforgeeks.org/__getitem__-and-__setitem__-in-python/)
...
**Relevant topics:** [add, and radd example](https://www.python-course.eu/python3_magic_methods.php)
...
**Motivation:** We covered a _lot_ this year! When dealing with data driven projects, it is useful to explore the data, and answer different questions to get a feel for it. There are always different ways one can go about this. Proper preparation prevents poor performace, in this project we are going to practice using some of the skills you've learned, and review topics and languages in a generic way.
...
##### 2. Which listed manufacturer has the most expensive previously owned car listed in Craiglist? Use the `/class/datamine/data/craigslist/vehicles.csv` dataset to answer this question. Only consider listings that have listed price less than $500,000 _and_ where manufacturer information is available.
...
**Hint:** It _may_ take a minute to run, depending on the tool you use.
...
**Motivation:** As we mentioned before, data wrangling is a big part in any data driven project. ["Data Scientists spend up to 80% of the time on data cleaning and 20 percent of their time on actual data analysis."](https://www.amazon.com/Exploratory-Data-Mining-Cleaning/dp/0471268518) Therefore, it is worth to spend some time mastering how to best tidy up our data.
...
**Relevant topics:** [read_csv](https://www.rdocumentation.org/packages/qtl2/versions/0.24/topics/read_csv), [str](#r-str), [glimpse](https://www.rdocumentation.org/packages/dplyr/versions/0.3/topics/glimpse), [head](#r-head)
...
**Relevant topics:** [pivot_longer](#r-pivot_longer)
...
**Relevant topics:** [geom_histogram](), [facet_wrap](#r-facet_wrap), [facet_grid](#r-facet_grid) 
...
**Relevant topics:** [%>%](#r-piping), [mutate](#r-mutate), [case_when](#r-case_when)
...
**Relevant topics:** [group_by](#r-group_by), [summarize](#r-summarize), [mean](#r-mean), [n](https://dplyr.tidyverse.org/reference/n.html)
...
##### 3. Using `ggplot2`, create a scatterplot showing the relationship between `percent_timely_response` and 
`percent_consumer_disputed` for companies with at least 500 complaints. Based on your results, do you believe there is an association between how timely the company's response is, and whether the consumer disputes? Why or why not?

**Hint:** Remember, here we consider each row of `companyDF` a unique company.

**Relevant topics:** [filter](#r-filter), [geom_point](#r-geom_point)
...
**Relevant topics:** [filter](#r-filter), [arrange](#r-arrange)
