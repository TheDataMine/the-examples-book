...
**Hint:** Using and if statement and the [modulo operator](https://www.jquery-az.com/python-modulo/) could be useful.
...
**Hint:** What would be shown in the browser is a super common (and annoying) puzzle. Look at the HTML and you'll see the name of this puzzle.
...
**Note:** `backoff` utilizes decorators. For those interested in learning about decorators, [this](https://realpython.com/primer-on-python-decorators/) is an excellent article. Otherwise, you should be able to read the provided documentation to make things work.

**Relevant topics:** [requests](#p-requests), [decorators](#p-decorators)
