...
- A `Card` class with an updated `__eq__` method. **Make sure to add your `__add__` and `__radd__` methods to the provided `Card` class. They are necessary to make everything work.**
...
- create and sum a hand of cards
- create a new player
- our game is simplified and each player can have a strategy
- create a game and play it and print the players
- Create your own strategy, how does it compare? Create a graphic?
