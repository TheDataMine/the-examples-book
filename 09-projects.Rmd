...
fix_businesses_data(data_path="/class/datamine/data/yelp/data/parquet/businesses.parquet", output_dir="/scratch/scholar/{my_username}")

# see if output exists
p = Path("/scratch/scholar/{my_username}").glob('**/*')
