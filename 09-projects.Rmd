...
##### NOTE:  You do NOT need to include this portion of Question 5 in your Markdown `.Rmd` file.  We cannot get this portion to build in RMarkdown, but please do include it in your Python `.py` file.
